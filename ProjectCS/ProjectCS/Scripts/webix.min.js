...
(c) XB Software Ltd.
*/
window.webix||(webix={}),webix.version="2.3.14",webix.codebase="./",webix.name="core",webix.clone=function(t){var e=webix.clone.a;return e.prototype=t,new e},webix.clone.a=function(){},webix.extend=function(t,e,i){if(t.b)return webix.PowerArray.insertAt.call(t.b,e,1),t;for(var s in e)(!t[s]||i)&&(t[s]=e[s]);
...
},index:function(t){for(var e=0;t=t.previousSibling;)e++;return e},n:{},createCss:function(t){var e="";for(var i in t)e+=i+":"+t[i]+";";var s=this.n[e];return s||(s="s"+webix.uid(),this.addStyle("."+s+"{"+e+"}"),this.n[e]=s),s},addStyle:function(t){var e=document.createElement("style");e.setAttribute("type","text/css"),e.setAttribute("media","screen"),e.styleSheet?e.styleSheet.cssText=t:e.appendChild(document.createTextNode(t)),document.getElementsByTagName("head")[0].appendChild(e)
...
},stopEvent:function(t){return(t||event).cancelBubble=!0,!1},addCss:function(t,e){t.className+=" "+e},removeCss:function(t,e){t.className=t.className.replace(RegExp(" "+e,"g"),"")}},webix.ready=function(t){this.o?t.call():this.p.push(t)},webix.p=[],function(){var t=document.getElementsByTagName("SCRIPT");
...
i&&i.prototype&&i.prototype.$skin&&i.prototype.$skin(i.prototype)}},webix.skin.set(window.webix_skin||"flat"),webix.Destruction={$init:function(){webix.destructors.push(this)},destructor:function(){if(this.di&&this.editCancel(),this.callEvent&&this.callEvent("onDestruct",[]),this.destructor=function(){},this.getChildViews){var t=this.getChildViews();
if(t)for(var e=0;e<t.length;e++)t[e].destructor();if(this.Ns)for(var e=0;e<this.Ns.length;e++)this.Ns[e].destructor()}delete webix.ui.views[this.s.id],this.t=null,this.u=null,this.v=null,this.w&&(this.w.innerHTML="",this.w.t=null),this.x&&this.x.parentNode&&this.x.parentNode.removeChild(this.x),this.data&&this.data.destructor&&this.data.destructor(),this.unbind&&this.unbind(),this.data=null,this.x=this.$view=this.w=this.y=null,this.i=this.j={},webix.UIManager.A==this&&(webix.UIManager.A=null);
var i=this.s.url;i&&i.$proxy&&i.release&&i.release(),this.$scope=null,this.$destructed=!0}},webix.destructors=[],webix.event(window,"unload",function(){webix.callEvent("unload",[]),webix.B=!0;for(var t=0;t<webix.destructors.length;t++)webix.destructors[t].destructor();webix.destructors=[],webix.ui.et=webix.toArray();
...
},G:function(t,e,i,s,n){e&&(webix.isArray(e)||"function"==typeof(e.success||e.error||e))&&(s=i,i=e,e=null);var r=webix.promise.defer(),a=this.getXHR();if(webix.isArray(i)||(i=[i]),i.push({success:function(t,e){r.resolve(e)},error:function(){r.reject(a)}}),webix.callEvent("onBeforeAjax",[n,t,e,a])){if("object"==typeof e){var h=[];
for(var o in e){var l=e[o];(null===l||l===webix.undefined)&&(l=""),"object"==typeof l&&(l=this.stringify(l)),h.push(o+"="+encodeURIComponent(l))}e=h.join("&")}e&&"GET"===n&&(t=t+(-1!=t.indexOf("?")?"&":"?")+e),a.open(n,t,!this.H);var c=this.Tw;if(c&&(a.responseType=c),this.I)for(var u in this.I)a.setRequestHeader(u,this.I[u]);
else"GET"!==n&&a.setRequestHeader("Content-type","application/x-www-form-urlencoded");var d=this;return this.master=this.master||s,a.onreadystatechange=function(){if(!a.readyState||4==a.readyState){if(webix.ajax.count++,i&&d&&!a.aborted){var t,e,n=d.master||d,r=a.status>=400;"blob"!=a.responseType?(t=a.responseText||"",e=d.J(a)):(t="",e=a.response),webix.ajax.$callback(n,i,t,e,a,r)
}d&&(d.master=null),i=d=s=null}},this.H?a.send(e||null):setTimeout(function(){a.aborted||a.send(e||null)},1),this.master&&this.master.Ve&&this.master.Ve.push(a),this.H?a:r}},J:function(x){return{xml:function(){try{return webix.DataDriver.xml.tagToObject(webix.DataDriver.xml.toObject(x.responseText,this))
...
},post:function(t,e,i){return this.G(t,e,i,0,"POST")},put:function(t,e,i){return this.G(t,e,i,0,"PUT")},del:function(t,e,i){return this.G(t,e,i,0,"DELETE")},sync:function(){return this.H=!0,this},response:function(t){return this.Tw=t,this},header:function(t){return this.I=t,this},headers:function(t){return this.I=t,this
...
this.Ps=this.attachEvent(this.touchable?"onAfterRender":"onBindRequest",function(){return t.getBindData(s)}),this.refresh&&this.isVisible(this.s.id)&&this.refresh()},unbind:function(){if(this.Os){var t=webix.$$(this.Os);t&&t.removeBind(this.s.id),this.detachEvent(this.Ps),this.Os=null}},X:function(){if(this.filter){var t=this.s.id;
this.data.Y=webix.bind(function(){webix.$$(this.Os).Z[t]=!1},this)}var e=this.render;this.render=function(){if(!this.$){this.$=!0;var t=this.callEvent("onBindRequest");return this.$=!1,e.apply(this,t===!1?arguments:[])}},(this.getValue||this.getValues)&&(this.save=function(){return this.validate&&!this.validate()?!1:(webix.$$(this.Os).setBindData(this.getValue?this.getValue:this.getValues(),this.s.id),void(this.setDirty&&this.setDirty(!1)))
}),!this.s.dataFeed&&this.loadNext&&this.data.attachEvent("onStoreLoad",webix.bind(function(){this.Os&&(webix.$$(this.Os).Z[this.s.id]=!1)},this)),this.X=function(){}}},webix.BindSource={$init:function(){this.bb={},this.Z={},this.cb={},this.db(this)},saveBatch:function(t){this.eb=!0,t.call(this),this.eb=!1,this.fb()
...
return t?t.isEnabled():!0},disable:function(){webix.html.remove(this.$b),this.s.disabled=!0,this.$b=webix.html.create("div",{"class":"webix_disabled"}),window.getComputedStyle&&(this._b=window.getComputedStyle(this.x,null).getPropertyValue("position")),"absolute"!=this._b&&(this.x.style.position="relative"),this.x.appendChild(this.$b),webix.UIManager.vb(this)
},enable:function(){this.s.disabled=!1,this.$b&&(webix.html.remove(this.$b),this.$b=null,this._b&&(this.x.style.position=this._b))},disabled_setter:function(t){return t?this.disable():this.enable(),t},container_setter:function(t){return!0},css_setter:function(t){return"object"==typeof t&&(t=webix.html.createCss(t)),this.x.className+=" "+t,t
},id_setter:function(t){if(webix.Mb&&webix.Mb!=this){var e=this.config.$id=t;webix.Mb.Hb[t]=this,t=webix.ui.Tb(this.name),webix.Mb.Ib[t]=e}return webix.ui.views[t]=this,this.x.setAttribute("view_id",t),t},$setSize:function(t,e){var i=this.ac;return i&&i[0]==t&&i[1]==e?!1:(this.ac=[t,e],this.$width=this.bc=t-(this.cc?webix.ui.scrollSize:0),this.$height=this.dc=e-(this.ec?webix.ui.scrollSize:0),this.x.style.width=t+"px",this.x.style.height=e+"px",!0)
},$getSize:function(t,e){var i=this.s,s=[i.width||i.minWidth||0,i.width||i.maxWidth||1e5,i.height||i.minHeight||0,i.height||i.maxHeight||1e5,i.gravity];return s[0]+=t,s[1]+=t,s[2]+=e,s[3]+=e,s},show:function(t,e){var i=this.getParentView(),s=!arguments[2];if(i)!e&&e!==!1&&this.s.animate&&i.s.animate&&(e=webix.extend(i.s.animate?webix.extend({},i.s.animate):{},this.s.animate,!0)),(s?i.fc:i.Fb)&&(s?i.fc:i.Fb).call(i,this,e),t&&s&&i.show(t);
...
},reconstruct:function(){this.Qb(this.nc)},Fb:function(t,e,i){t.s.hidden||(t.s.hidden=!0,webix.html.remove(t.x),this.qc++,i||webix.Nb||this.resizeChildren(!0))},Lw:function(t){t.callEvent&&t.callEvent("onViewShow",[])},resizeChildren:function(){if(this.lc){var t=this.getParentView();if(t)return t.resizeChildren?t.resizeChildren():t.resize();
var e,i,s,n,r=this.$getSize(0,0);s=e=this.lc[0]||0,n=i=this.lc[1]||0,t?this.rc(e,i):(r[0]>e&&(s=r[0]),r[2]>i&&(n=r[2]),e>r[1]&&(s=r[1]),i>r[3]&&(n=r[3]),this.$setSize(s,n))}},getChildViews:function(){return this.q},index:function(t){t.s&&(t=t.s.id);for(var e=0;e<this.q.length;e++)if(this.q[e].s.id==t)return e;
return-1},fc:function(t,e,i){if(t.s.hidden){t.s.hidden=!1;for(var s=this.index(t)+1;this.q[s]&&this.q[s].s.hidden;)s++;var n=this.q[s]?this.q[s].x:null;webix.html.insertBefore(t.x,n,this.y||this.x),this.qc--,i||(this.resizeChildren(!0),t.refresh&&t.refresh()),t.callEvent&&(t.callEvent("onViewShow",[]),webix.ui.each(t,this.Lw))
...
return u[1]>=1e5&&(u[1]=0),u[3]>=1e5&&(u[3]=0),u[0]=(u[0]||i)+t,u[1]=Math.max(u[0],(u[1]||s)+t),u[2]=(u[2]||r)+e,u[3]=Math.max(u[2],(u[3]||n)+e),u},$setSize:function(t,e){this.lc=[t,e],webix.ui.baseview.prototype.$setSize.call(this,t,e),this.rc(t,e)},wc:function(t,e,i){e=t[e],i=t[i];var s=e;if(e!=i){var n=this.xc*t[4]/this.yc;
if(e>n)s=e,this.yc-=t[4],this.xc-=s;else{if(!(n>i))return-1;s=i,this.yc-=t[4],this.xc-=s}}return s},it:function(t,e){var i=webix.$$(e);"hide"!==i&&i?(i||(i=webix.ui({view:"popup",body:[{}]})),t.jt=t.s.width,t.kt=t.s.height,t.lt=i.s.id,t.s.width=0,t.s.height||(t.s.autoheight=!0),webix.ui(t,i,this.ht.length)):(t.hide(),webix.delay(this.resize,this),t.lt="hide"),this.ht.push(t)
...
},webix.animate.breakLine=function(t){webix.html.remove(t[1]),webix.animate.clear(t[0]),webix.animate.clear(t[1]),t[0].style.position=""},webix.animate.clear=function(t){t.style[webix.env.transform]="none",t.style[webix.env.transition]="none",t.style.top=t.style.left=""},webix.animate.defaults={type:"slide",delay:"0",duration:"500",timing:"ease-in-out",x:0,y:0},webix.animate.start=function(t,e){"string"==typeof e&&(e={type:e}),e=webix.Settings.E(e,webix.animate.defaults);
var i,s,n=webix.env.cssPrefix,r=t.Mc=e;switch("slide"==r.type&&r.direction){case"right":r.x=t.offsetWidth;break;case"left":r.x=-t.offsetWidth;break;case"top":r.y=-t.offsetHeight;break;case"bottom":default:r.y=r.y||t.offsetHeight}("flip"==r.type||"flipback"==r.type)&&(i=[0,0],s="scaleX","vertical"==r.subtype?(i[0]=20,s="scaleY"):i[1]=20,("right"==r.direction||"bottom"==r.direction)&&(i[0]*=-1,i[1]*=-1));
var a=r.duration+"ms "+r.timing+" "+r.delay+"ms",h=n+"TransformStyle: preserve-3d;",o="",l="";switch(r.type){case"fade":o="opacity "+a,h="opacity: 0;";break;case"show":o="opacity "+a,h="opacity: 1;";break;case"flip":a=r.duration/2+"ms "+r.timing+" "+r.delay+"ms",l="skew("+i[0]+"deg, "+i[1]+"deg) "+s+"(0.00001)",o="all "+a;
break;case"flipback":r.delay+=r.duration/2,a=r.duration/2+"ms "+r.timing+" "+r.delay+"ms",t.style[webix.env.transform]="skew("+-1*i[0]+"deg, "+-1*i[1]+"deg) "+s+"(0.00001)",t.style.left="0",l="skew(0deg, 0deg) "+s+"(1)",o="all "+a;break;case"slide":var c=r.x+"px",u=r.y+"px";l=webix.env.translate+"("+c+", "+u+("translate3d"==webix.env.translate?", 0":"")+")",o=n+"transform "+a
}webix.delay(function(){t.style[webix.env.transition]=o,webix.delay(function(){h&&(t.style.cssText+=h),l&&(t.style[webix.env.transform]=l);var e=!1,i=webix.event(t,webix.env.transitionEnd,function(s){t.Mc=null,r.callback&&r.callback.call(r.master||window,t,r,s),e=!0,webix.eventRemove(i)});window.setTimeout(function(){e||(t.Mc=null,r.callback&&r.callback.call(r.master||window,t,r),e=!0,webix.eventRemove(i))
},1.3*(1*r.duration+1*r.delay))})})},webix.MouseEvents={$init:function(t){t=t||{},this.Oc=0,this.Pc=300,this.Qc=null,this.Rc(t.onClick,"on_click"),this.Rc(t.onContext,"on_context"),this.Rc(t.onDblClick,"on_dblclick"),this.Rc(t.onMouseMove,"on_mouse_move"),this.on_click&&(webix.event(this.w,"click",this.Sc,this),webix.env.isIE8&&this.on_dblclick&&webix.event(this.w,"dblclick",this.Tc,this)),this.on_context&&webix.event(this.w,"contextmenu",this.Uc,this),this.on_mouse_move&&this.Vc()
...
if(a){if(a!==r)return}else n.w_view=r}for(var h="",o=null,l=!1;n&&n.parentNode;){if(!l&&n.getAttribute&&(o=n.getAttribute(this.ad))){if(this.Qc=o,this.callEvent){if(!this.callEvent("on"+i,[o,t,n]))return;s&&this.callEvent("on"+s,[o,t,n])}l=!0}if(h=n.className){h=h.split(" ");for(var c=0;c<h.length;c++)if(e[h[c]]){var u=webix.toFunctor(e[h[c]],this.$scope),d=u.call(this,t,o||webix.html.locate(t,this.ad),n);
...
},Bd:function(t){webix.DragControl.zd(),webix.DragControl.td=null,webix.DragControl.Cd&&(webix.DragControl.$drop(webix.DragControl.sd,webix.DragControl.Cd,t),webix.DragControl.$dragOut(webix.DragControl.sd,webix.DragControl.Cd,null,t)),webix.DragControl.destroyDrag(),webix.DragControl.sendSignal("stop")
...
},Id:function(){webix.DragControl.Ed=!0},destroyDrag:function(){var t=webix.DragControl.sd,e=this.pd[t.webix_drag];e&&e.$dragDestroy?(webix.DragControl.Hd=webix.eventRemove(webix.DragControl.Hd),webix.DragControl.v&&e.$dragDestroy(t,webix.DragControl.v)):webix.html.remove(webix.DragControl.v),webix.DragControl.Dd=webix.DragControl.sd=webix.DragControl.Cd=webix.DragControl.v=null
...
},Qb:function(t){this.gd.destructor(),this.gd=t,this.gd.Xb=this,this.ed.appendChild(this.gd.x);var e=this.gd.x.style;e.borderTopWidth=e.borderBottomWidth=e.borderLeftWidth=e.borderRightWidth="1px",this.gd.s.Ob=webix.clone(this.s.Ob),this.resize(!0)},show:function(t,e,i){this.s.hidden=!1,this.x.style.zIndex=this.s.zIndex||webix.ui.zIndex(),this.s.modal&&this.Md(!0);
var s,n,r;if(e=e||{},e.pos||(e.pos=this.s.relative),t){"object"!=typeof t||t.tagName?(t=webix.toNode(t),s=webix.html.offset(t)):t.target||t.srcElement?(s=webix.html.pos(t),n=20,r=5):s=t;var a=Math.max(window.innerWidth||0,document.body.offsetWidth),h=Math.max(window.innerHeight||0,document.body.offsetHeight);
n=n||t.offsetWidth||0,r=r||t.offsetHeight||0;var o=this.ac,l=s.x,c=s.y,u=0,d=0;if(this.s.autofit){var f=6,b=6,p=6;i="top",c=0,l=0,a-s.x-n<o[0]&&"right"==e.pos&&(e.pos="left"),"right"==e.pos?(l=s.x+f+n,b=-r,i="left",u=Math.round(s.y+r/2),d=l-p):"left"==e.pos?(l=s.x-f-o[0]-1,b=-r,i="right",u=Math.round(s.y+r/2),d=l+o[0]+1):(l=s.x<0?0:a-s.x>o[0]?s.x:a-f-o[0],d=Math.round(s.x+n/2),d>l+o[0]&&(d=l+o[0]/2)),(!o[1]||h-r-s.y-b>o[1])&&"top"!=e.pos?(c=r+s.y+b-4,u||(i="top",u=c-p)):(c=s.y-b-o[1],0>c?(c=0,"top"==i&&(i=!1)):u||(i="bottom",c--,u=c+o[1]+1))
}var x=e.x||0,v=e.y||0;this.setPosition(l+x,c+v),this.Rd&&(i?this.Rd(i,d+x,u+v):this.Sd())}else this.s.position&&this.Td();this.x.style.display="block",this.Ww=1,webix.delay(function(){this.Ww=0},this,[],webix.env.touch?400:100),this.Qd(),this.config.autofocus&&(this.Vd=webix.UIManager.getFocus(),webix.UIManager.setFocus(this)),-1==webix.ui.et.find(this)&&webix.ui.et.push(this),this.callEvent("onShow",[])
...
},hide:function(t){(t||!this.s.hidden)&&(this.s.modal&&this.Md(!1),"top"==this.s.position?webix.animate(this.x,{type:"slide",x:0,y:-(this.dc+20),duration:300,callback:this.Wd,master:this}):this.Wd(),this.s.autofocus&&(webix.UIManager.setFocus(this.Vd),this.Vd=null),this._x())},_x:function(){var t=webix.ui.et,e=t.find(this),i=t.length-1;
if(e>-1)for(var s=i;s>e;s--)t[s].Sd&&t[s].hide();t.removeAt(e)},destructor:function(){this.s.autofocus&&(webix.B||webix.UIManager.setFocus(this.Vd),this.Vd=null),this._x(),webix.Destruction.destructor.apply(this,[])},Wd:function(){this.$destructed||(this.x.style.display="none",this.s.hidden=!0,this.callEvent("onHide",[]))
...
e&&t.id?i.refresh():i.setValue(i.options_setter?t.id:t.text||t.value)}else this.ae&&(this.ae.value=t.text||t.value);e||(this.hide(!0),this.ae&&this.ae.focus()),this.callEvent("onValueSuggest",[t]),webix.delay(function(){webix.callEvent("onEditEnd",[])})},getMasterValue:function(){return this.s.master?webix.$$(this.s.master).getValue():null
},getItemText:function(t){var e=this.getList().getItem(t);if(!e)return this.ay[t]||"";if(this.s.template)return this.s.template.call(this,e,this.type);if(this.s.textValue)return e[this.s.textValue];var i=this.getList().type,s=i.template.call(i,e,i);return this.ay[t]=s},getSuggestion:function(){var t,e=this.getList();
return e.getSelectedId&&(t=e.getSelectedId()),!t&&e.data.order.length&&(t=e.data.order[0]),t&&"object"==typeof t&&(t+=""),t},getList:function(){return this.gd},_d:function(){var t=this.getList(),e=this.s.type;t.count?(t.attachEvent("onItemClick",webix.bind(function(e){this.setMasterValue(t.getItem(e))
...
},show:function(t){if(!this.isVisible()){var e=this.getList();e.filter&&!this.je?(e.filter(""),e.select&&this.ke(e)):this.je=!1,t.tagName&&this.s.fitMaster&&(this.s.width=t.offsetWidth-2),e.Np&&e.render(),this.adjust()}webix.ui.popup.prototype.show.apply(this,arguments)},ke:function(t){var e=this.getMasterValue();
e&&t.exists&&t.exists(e)?t.select(e):(t.unselect(),t.showItem(t.getFirstId()))},ge:function(t,e){if(e.count&&e.count())if(t.isVisible()){var i=e.getSelectedId(!1,!0);i&&this.setMasterValue(e.getItem(i)),t.hide(!0)}else t.show(this.ae);else t.isVisible()&&t.hide(!0)},fe:function(t){return t.hide(!0)},ee:function(t){return t.hide(!0)
},he:function(t){var e=this.getList(),i=t.keyCode;if(e.count&&e.moveSelection){if(!(38!==i||t.ctrlKey||t.metaKey||t.shiftKey||t.altKey))return e.moveSelection("up"),this.Rs(e.getSelectedItem()),!0;if(!(40!==i||t.ctrlKey||t.metaKey||t.shiftKey||t.altKey)){var s=this.isVisible();if(!s){if(!e.count())return!1;
this.show(this.ae)}var n=e.getSelectedId();return!n&&e.count?e.select(e.getFirstId()):s&&e.moveSelection("down"),this.Rs(e.getSelectedItem()),!0}}return!1},getValue:function(){var t=this.getList().getSelectedId()||"";return t.id||t},setValue:function(t){var e=this.getList();t?e.exists(t)&&(e.select(t),e.showItem(t)):(e.unselect(),e.showItem(e.getFirstId()))
}},webix.ui.popup),webix.attachEvent("onClick",function(t){var e=webix.$$(t);if(e&&e.touchable){e.getNode(t);var i=t.target||t.srcElement;if("webix_disabled"==i.className)return;var s="";if(i.className&&0===i.className.indexOf("webix_view"))return;for(;i&&i.parentNode;){if(i.getAttribute){if(i.getAttribute("view_id"))break;
if(s=i.className){s=s.split(" ");for(var n=0;n<s.length;n++)if(e.on_click[s[n]]){var r=e.on_click[s[n]].call(e,t,e.s.id,i);if(r===!1)return}}}i=i.parentNode}if(e.s.click){var a=webix.toFunctor(e.s.click,e.$scope);a&&a.call&&a.call(e,e.s.id,t)}var h=e.s.popup;if(e.s.popup&&!e.s.readonly){"object"!=typeof h||h.name||(h=e.s.popup=webix.ui(h).s.id);
...
},getValue:function(){var t=this.se?this.$getValue():this.s.value;return"undefined"==typeof t?"":t},$getValue:function(){return this.s.value||""},focus:function(){var t=this.getInputNode();t&&t.focus&&t.focus()},blur:function(){var t=this.getInputNode();t&&t.blur&&t.blur()},getInputNode:function(){return this.y.getElementsByTagName("input")[0]
...
t!=this.s.value&&this.setValue(this.getValue(),!0)},this),this.s.suggest&&webix.$$(this.s.suggest).linkInput(this))},$skin:function(){this.defaults.height=webix.skin.$active.inputHeight,this.defaults.inputPadding=webix.skin.$active.inputPadding},$init:function(t){"top"==t.labelPosition&&webix.isUndefined(t.height)&&(t.height=this.defaults.height+this.le),this.Ns=[],this.Ct(),this.attachEvent("onAfterRender",this.De)
...
},validate:function(){var t=this.s.validate;!t&&this.s.required&&(t=webix.rules.isNotEmpty);var e=(this.getFormView(),this.s.name),i=this.getValue(),s={};return s[e]=i,t&&!this.getFormView().Se(t,i,s,e)?!1:!0},$setSize:function(t,e){if(webix.ui.view.prototype.$setSize.call(this,t,e)){if(!t||!e)return;
var i=this.s;"top"==i.labelPosition&&(i.inputHeight||(i.inputHeight=this.dc-this.le),i.labelWidth=0),this.render()}},Ee:function(t){var e=(this.we||0)-(t.label?this.s.labelWidth:0)-2*webix.skin.$active.inputPadding-(t.iconWidth||0);return 0>e?0:e},Fe:function(t,e){var i=t.id||webix.uid(),s=e.Ee(t),n=t.inputAlign||"left",r=(this.$renderIcon?this.$renderIcon(t):"",this.s.aheight-2*webix.skin.$active.inputPadding-2),a=t.text||t.value||this.Yx(t),h="<div class='webix_inp_static' tabindex='0' onclick='' style='line-height:"+r+"px;width: "+s+"px; text-align: "+n+";' >"+a+"</div>";
...
return t.label&&(r="<label style='"+n+"text-align: "+i+";line-height:"+a+"px;' onclick='' for='"+e+"' class='webix_inp_"+(s?"top_":"")+"label "+(t.required?"webix_required":"")+"'>"+(t.label||"")+"</label>"),r},$renderInput:function(t,e,i){var s=t.inputAlign||"left";i=i||t.name||webix.uid();var n=this.$renderLabel(t,i),r="";
if(e)r+=e;else{var a=this.Ee(t);r+=this.qt("input")+"id='"+i+"' type='"+(t.type||this.name)+"' value='"+webix.template.escape(t.value||"")+"' style='width: "+a+"px; text-align: "+s+";'";var h=this.s.attributes;if(h)for(var o in h)r+=" "+o+"='"+h[o]+"'";r+=" />"}var l=this.$renderIcon?this.$renderIcon(t):"";
return r+=l,r+="</div>",top?n+"<div class='webix_el_box' style='width:"+this.s.awidth+"px; height:"+this.s.aheight+"px'>"+r+"</div>":"<div class='webix_el_box' style='width:"+this.s.awidth+"px; height:"+this.s.aheight+"px'>"+n+r+"</div>"},defaults:{template:function(t,e){return e.$renderInput(t)},label:"",labelWidth:80},type_setter:function(t){return t
},oe:!1,$setValue:function(t){this.getInputNode().value=t},$getValue:function(){return this.getInputNode().value},suggest_setter:function(t){if(t){if("string"==typeof t){var e=webix.$$(t);if(e)return webix.$$(t).s.id;t={body:{url:t,dataFeed:t}}}else webix.isArray(t)?t={body:{data:this.Be(t)}}:t.body||(t.body={});
webix.extend(t,{view:"suggest"});var i=webix.ui(t);return this.Ns.push(i),i.s.id}return!1}},webix.ui.button),webix.protoUI({name:"segmented",Ce:!1,$init:function(){this.attachEvent("onChange",function(t){if(this.s.multiview){var e=this.getTopParentView(),i=null;e&&e.$$&&(i=e.$$(t)),i||(i=webix.$$(t)),i&&i.show&&i.show()
}})},defaults:{template:function(t,e){!t.options;var i=t.options;e.Be(i);var s=e.Ee(t),n=webix.uid(),r="<div style='width:"+s+"px' class='webix_all_segments'>",a=t.optionWidth||Math.floor(s/i.length);t.value||(t.value=i[0].id);for(var h=0;h<i.length;h++)r+="<button style='width:"+(i[h].width||a)+"px' ",r+="class='"+(t.value==i[h].id?"webix_selected ":"")+"webix_segment_"+(h==i.length-1?"N":h>0?1:0)+"' button_id='"+i[h].id+"' >",r+=i[h].value+"</button>";
...
}return!1}},this)),t},ef:function(){if(this.s.ready&&!this.hf){var t=webix.toFunctor(this.s.ready,this.$scope);t&&webix.delay(t,this,arguments),this.hf=!0}},We:function(){for(var t=0;t<this.Ve.length;t++){var e=this.Ve[t];e.aborted=!0,e.abort()}this.Ve=webix.toArray(),this.waitData=webix.promise.defer()
},Xe:function(t){this.C(t)}},webix.AtomDataLoader),webix.DataMarks={addCss:function(t,e,i){if(!this.addRowCss&&!i&&!this.hasCss(t,e)){var s=this.getItemNode(t);s&&(s.className+=" "+e,i=!0)}return this.data.addMark(t,e,1,1,i)},removeCss:function(t,e,i){if(!this.addRowCss&&!i&&this.hasCss(t,e)){var s=this.getItemNode(t);
...
var n=0,r=0,a=this.$master.y;this.$master.Vf&&(a=this.$master.Vf,r=this.$master.I,r.style.position="relative",r.style.zIndex="10",n=a.offsetTop);var h=a.cloneNode(!0);h.style.width=a.style.width="100%",h.style.backgroundColor=a.style.backgroundColor="white",this.$master.refresh(),a.parentNode.appendChild(h);
var o,l=i!==!0?i:{},c=webix.extend({direction:s,callback:webix.bind(function(){c.callback=null,webix.animate.breakLine(o),this.Tf=!1,r&&(r.style.position="")},this),top:n},l);o=webix.animate.formLine(a,h,c),webix.animate([a,h],c),this.Tf=!0}},webix.MouseEvents,webix.SingleRender,webix.ui.view,webix.EventSystem),webix.locale.pager={first:" &lt;&lt; ",last:" &gt;&gt; ",next:" &gt; ",prev:" &lt; "},webix.PagingAbility={pager_setter:function(t){function e(i){if(t.config.autosize&&this.getVisibleCount){var s=this.getVisibleCount();
isNaN(s)?(t.config.size=1,webix.delay(e,this,[!0])):s!=t.config.size&&(t.config.size=s,t.refresh(),i===!0&&this.refresh())}var n=this.s.pager;return-1==n.page?!1:(this.data.$min=n.page*n.size,this.data.$pagesize=n.size,this.data.$max=(n.page+1)*n.size-1,!0)}if("string"==typeof t){var i=webix.$$(t);if(!i)return this.$blockRender=!0,webix.delay(function(){var e=webix.$$(t);
this.s.pager=this.pager_setter(e),e.s.count=this.count(),e.refresh(),this.$blockRender=!1,this.render()},this),null;t=i}return this.attachEvent("onBeforeRender",e),t.$view||(t.view="pager",t=webix.ui(t)),this.Wf=t,t.$master=this,this.data.attachEvent("onStoreUpdated",function(){t.s.count=this.count(),t.refresh()
},null,!0),t.s},setPage:function(t){this.Wf&&this.Wf.select(t)},getPage:function(){return this.Wf.s.page},getPager:function(){return this.Wf}},webix.protoUI({name:"tooltip",defaults:{dy:0,dx:20},$init:function(t){"string"==typeof t&&(t={template:t}),this.type=webix.extend({},this.type),this.x=this.w=this.y=document.createElement("DIV"),this.w.className="webix_tooltip",webix.html.insertBefore(this.w,document.body.firstChild)
...
this.callEvent("onAfterLoad",[]),this.waitData.resolve()},Te:function(t,e){t&&this.elements[t]&&(this.Qe(t,e),webix.html.addCss(this.elements[t].x,"webix_invalid"))},Qe:function(t){t&&this.elements[t]&&this.elements[t].$view&&webix.html.removeCss(this.elements[t].x,"webix_invalid")}},webix.protoUI({name:"toolbar",defaults:{type:"toolbar"},Gc:!0,_f:"webix_toolbar",ag:!1,$init:function(t){t.borderless||(this.w.style.borderWidth="1px"),this.w.className+=" "+this._f
},Qs:function(){var t=this;t.elements={},webix.ui.each(this,function(e){return e.s.name&&e.getValue&&e.setValue&&(t.elements[e.s.name]=e,e.mapEvent&&e.mapEvent({onbeforetabclick:t,onaftertabclick:t,onitemclick:t,onchange:t})),e.setValues?!1:void 0}),this.setDirty(!1)},sc:function(){this.Qs()},Bc:function(t){var e=this.s;
return e.elements&&!t&&(this.nc=t=e.elements,this.mc=this.ag,delete e.elements),this.s.elementsConfig&&this.eg(this.nc,e.elementsConfig),t},eg:function(t,e){for(var i=0;i<t.length;i++){var s=t[i];webix.extend(s,e);var n=e;s.elementsConfig&&(n=webix.extend(webix.extend({},s.elementsConfig),e));var r;r=s.body?[s.body]:s.rows||s.cols||s.cells||s.body,r&&this.eg(r,n)
}},$getSize:function(t,e){var i=webix.ui.layout.prototype.$getSize.call(this,t,e),s=this.getParentView(),n=this.mc?3:1;return s&&this.mc!=s.mc&&(i[n]+=1e5),i},render:function(){},refresh:function(){this.render()}},webix.Scrollable,webix.AtomDataLoader,webix.Values,webix.ui.layout,webix.ValidateData),webix.protoUI({name:"template",$init:function(t){var e=this.fg[t.type];
...
},Ag:function(t,e){for(var i=this.wg.length-1;i>=0;i--)this.wg[i]==t&&(this.wg[i]=e)},zg:function(){for(var t=this.wg.length-1;t>=0;t--)if(this.data.getIndexById(this.wg[t])<0){var e=this.wg[t];this.removeCss(e,"webix_selected",!0),this.wg.splice(t,1),this.callEvent("onSelectChange",[e])}},xg:function(t,e,i){if("delete"==i)if(this.loadBranch)for(var s=this.wg.length-1;s>=0;s--)this.exists(this.wg[s])||this.wg.splice(s,1);
else this.wg.remove(t);else t||this.data.count()||this.data.jf||(this.wg=webix.toArray())},yg:function(){this.s.select&&this.data.each(function(t){t&&t.$selected&&this.select(t.id)},this)},Bg:function(t,e,i){return i||this.callEvent("onBeforeSelect",[t,e])?(e?this.addCss(t,"webix_selected",!0):this.removeCss(t,"webix_selected",!0),i?i.push(t):(e?this.wg.push(t):this.wg.remove(t),this.Cg(t)),!0):!1
...
else for(var e=0;e<t.length;e++)this.render(t[e],this.data.getItem(t[e]),"update");this.Dg||this.callEvent("onSelectChange",[t])}}},webix.TreeDataMove={$init:function(){},copy:function(t,e,i,s){return s=s||{},s.copy=!0,this.move(t,e,i,s)},Kd:function(t,e,i){if(e&&t){var s=this.getBranchIndex(t);return s+(i==this&&i.getBranchIndex(e)<s?0:1)
}},Lt:function(t,e){var i=this.data.branch[t];if(i&&i.length)for(var s=0;s<i.length;s++){if(i[s]==e)return!0;if(this.Lt(i[s],e))return!0}return!1},move:function(t,e,i,s){s=s||{},e=e||0;var n=s.newId||t,r=s.parent||0;if(i=i||this,i.data){if(!webix.isArray(t)){if(this!=i||s.copy){if(n=i.data.add(i.Jd(this.getItem(t),n),e,r||0),this.data.branch[t]&&i.getBranchIndex){var a=this.data.vf;
this.data.vf=function(t){var e=webix.copy(t);return delete e.$parent,delete e.$level,delete e.$child,i.data.pull[e.id]&&(e.id=webix.uid()),e};var h={data:this.serialize(t,!0),parent:n};this.data.vf=a,i.parse(h)}s.copy||this.data.remove(t)}else{if(t==r||this.Lt(t,r))return;var o=this.getItem(t),l=this.data.branch[r];
l||(l=this.data.branch[r]=[]);var c=this.data.branch[o.$parent],u=webix.PowerArray.find.call(c,t);if(0>e&&(e=Math.max(l.length-1,0)),c===l&&e===u)return;if(webix.PowerArray.removeAt.call(c,u),webix.PowerArray.insertAt.call(l,t,Math.min(l.length,e)),c=this.data.branch[o.$parent],o.$parent&&"0"!=o.$parent&&this.getItem(o.$parent).$count--,r&&"0"!=r){var d=i.getItem(r);
d.$count++,this.Fg(o,d.$level+1)}else this.Fg(o,1);o.$parent=r,i.data.callEvent("onDataMove",[t,e,r])}return this.refresh(),n}for(var f=0;f<t.length;f++){var b=this.move(t[f],e,i,s);e=i.Kd(b,t[f+1],this)}}},Fg:function(t,e){t.$level=e;var i=this.data.branch[t.id];if(i)for(var s=0;s<i.length;s++)this.Fg(this.getItem(i[s]),e+1)
},Gg:function(t){t&&!t.header&&this.open(t)},$dropAllow:function(t){if(t.from!=t.to)return!0;for(var e=0;e<t.source.length;e++)if(t.source==t.target||this.Lt(t.source,t.target))return!1;return!0},Jd:function(t,e){var i=webix.DataMove.Jd.call(this,t,e);return delete i.open,i}},webix.TreeDataLoader={$init:function(){this.data.attachEvent("onStoreUpdated",webix.bind(this.Hg,this)),this._e=this.Ig,this.loadNext=this.Jg,this.$ready.unshift(this.Hg)
...
this.branch[s]=r}return e},add:function(t,e,i){var s=!1;this.branch[i||0]=this.order=webix.toArray(this.branch[i||0]);var n=this.getItem(i||0);if(n&&(this.branch[n.id]||(s=!0),n.$count++),t.$count=0,t.$level=n?n.$level+1:1,t.$parent=n?n.id:0,this.Mg){var r=this.Mg[i||0].length;!e&&this.branch[i||0].length&&(r=0),this.Mg[i||0]=webix.toArray(this.Mg[i||0]),this.Mg[i||0].insertAt(t.id,r)
}var a=webix.DataStore.prototype.add.call(this,t,e);return s&&this.refresh(i),a},Rg:function(t){var e=this.pull[t];if(this.branch[e.id]>0)for(var i=this.branch[t],s=0;s<i.length;s++)this.Rg(i[s],!0);delete this.branch[t],this.Mg&&delete this.Mg[t],delete this.pull[t],this.Me[t]&&delete this.Me[t]},remove:function(t){var e=this.pull[t],i=e.$parent||0;
if(this.callEvent("onBeforeDelete",[t])===!1)return!1;this.Rg(t),this.callEvent("onAfterDelete",[t]);var s=this.pull[i],n=this.branch[i];1==n.length&&i?delete this.branch[i]:webix.toArray(n).remove(t);var r=0;s&&(s.$count--,s.$count||(s.open=0,r=1)),this.callEvent("onStoreUpdated",[t,e,"delete"]),r&&this.refresh(s.id)
},getBranch:function(t){var e=[],i=(this.Mg||this.branch)[t];if(i)for(var s=0;s<i.length;s++)e[s]=this.pull[i[s]];return e},serialize:function(t,e){var i=this.branch;e&&this.Mg&&(i=this.Mg);for(var s=this.branch[t||0],n=[],r=0;r<s.length;r++){var a,h=this.pull[s[r]];if(this.vf){if(a=this.vf(h),a===!1)continue
}else a=webix.copy(h);this.branch[h.id]&&(a.data=this.serialize(h.id,e)),n.push(a)}return n}},webix.TreeType={space:function(t){for(var e="",i=1;i<t.$level;i++)e+="<div class='webix_tree_none'></div>";return e},icon:function(t){return t.$count?t.open?"<div class='webix_tree_open'></div>":"<div class='webix_tree_close'></div>":"<div class='webix_tree_none'></div>"
},checkbox:function(t){return t.nocheckbox?"":"<input type='checkbox' class='webix_tree_checkbox' "+(t.checked?"checked":"")+(t.disabled?" disabled":"")+">"},folder:function(t){return t.icon?"<div class='webix_tree_file webix_tree_"+t.icon+"'></div>":t.$count?t.open?"<div class='webix_tree_folder_open'></div>":"<div class='webix_tree_folder'></div>":"<div class='webix_tree_file'></div>"
}},webix.TreeAPI={open:function(t){if(t){var e=this.getItem(t);e.$count&&!e.open&&this.callEvent("onBeforeOpen",[t])&&(e.open=!0,this.data.callEvent("onStoreUpdated",[t,0,"branch"]),this.callEvent("onAfterOpen",[t]))}},close:function(t){if(t){var e=this.getItem(t);e.open&&this.callEvent("onBeforeClose",[t])&&(e.open=!1,this.data.callEvent("onStoreUpdated",[t,0,"branch"]),this.callEvent("onAfterClose",[t]))
}},openAll:function(t){this.data.eachSubItem(t||0,function(t,e){e&&(t.open=!0)}),this.data.refresh()},closeAll:function(t){this.data.eachSubItem(t||0,function(t,e){e&&(t.open=!1)}),this.data.refresh()},Sg:function(t,e,i){if(this.s.threeState)return this.Tg(t,null!==e?e:"");var s=this.getItem(t);s.checked=null!==e?e:!s.checked,this.callEvent("onItemCheck",[t,s.checked,i])
},isBranchOpen:function(t){if("0"==t)return!0;var e=this.getItem(t);return e.open?this.isBranchOpen(e.$parent):!1},getOpenItems:function(){var t=[];for(var e in this.data.branch)this.exists(e)&&this.getItem(e).open&&t.push(e);return t},getState:function(){return{open:this.getOpenItems(),select:this.getSelectedId(!0)}
},Ug:function(t,e){var i=this.data.attachEvent("onStoreLoad",function(){t.setState.call(t,e),t.data.detachEvent(i),t=null})},setState:function(t){if(t.open){this.closeAll();for(var e=t.open,i=0;i<e.length;i++){var s=this.getItem(e[i]);if(s&&s.$count&&(s.open=!0,-1==s.$count))return this.Ug(this,t),this.refresh(),0
}this.refresh()}if(t.select&&this.select){var n=t.select;this.unselect();for(var i=0;i<n.length;i++)this.exists(n[i])&&this.select(n[i],!0)}return 1}},webix.TreeClick={webix_tree_open:function(t,e){return this.close(e),!1},webix_tree_close:function(t,e){return this.open(e),!1},webix_tree_checkbox:function(t,e){return this.Sg(e,null,t),!1
}},webix.TreeCollection=webix.proto({name:"TreeCollection",$init:function(){webix.extend(this.data,webix.TreeStore,!0),this.data.provideApi(this,!0)}},webix.TreeDataLoader,webix.DataCollection),webix.DragOrder={Vg:!0,$drag:function(t,e){var i=webix.DragItem.$drag.call(this,t,e);if(i){var s=webix.DragControl.getContext();
this.getBranchIndex&&(this.Wg=this.Xg?16*this.getItem(s.start).$level:0),s.fragile||this.addCss(s.start,"webix_transparent")}return i},$dragPos:function(t,e,i){var s=webix.html.offset(this.$view),n=s.x+(this.Xg?+s.width-webix.ui.scrollSize-1:1);i.style.display="none";var r=document.elementFromPoint(n,t.y);
if(r!=this.Yg){var a=webix.$$(r);if(a&&a==this){var h=this.locate(r);h&&this.Zg&&(h=this.Zg(h));var o=webix.DragControl.getContext().start;if(h){if(h!=this.Yg){if(h!=o){var l,c;this.getBranchIndex?(l={parent:this.getParentId(h)},c=this.getBranchIndex(h)):(l={},c=this.getIndexById(h)),this.callEvent("onBeforeDropOrder",[o,c,e,l])&&(this.move(o,c,this,l),this.Yg=h)
}webix.DragControl.Cd=this.w}}else if(h="$webix-last",this.Yg!=h){if(!this.callEvent("onBeforeDropOrder",[o,-1,e,{parent:0}]))return;this.Yg=h}}}if(i.style.display="block",s.y+=this.$g,t.x=this.Wg||s.x,t.y=t.y-18,t.y<s.y)t.y=s.y;else{var u=s.y+this.$view.offsetHeight-60;t.y>u&&(t.y=u)}webix.DragControl.Ed=!0
},$dragIn:function(){return!1},$drop:function(t,e,i){var s=webix.DragControl.getContext(),n=s.start;this.removeCss(n,"webix_transparent");var r=this.getIndexById(n);this.callEvent("onAfterDropOrder",[n,r,i]),s.fragile&&this.refresh()}},webix.DragItem={_g:function(t,e,i){e||webix.DragControl.addDrop(t.w,t,!0),i||webix.DragControl.addDrag(t.w,t),this.attachEvent("onDragOut",function(t,e){this.$dragMark(t,e)
})},drag_setter:function(t){return t&&("order"==t&&webix.extend(this,webix.DragOrder,!0),"inner"==t&&(this.ah=!0),this._g(this,"source"==t,"target"==t),delete this.drag_setter),t},$dragIn:function(t,e,i){var s=this.locate(i)||null,n=webix.DragControl.Gd;if((this.ah||n.from.ah)&&n.from!==this)return!1;
...
if(!d){var f=this.pull[u]={id:u,value:c,$group:!0,$row:i.row};h.push(f),d=this.branch[u]=[],d.lh=[],a.push(u)}d.push(l.id),d.lh.push(l)}this.branch[e]=a;for(var b in i.map){var p=i.map[b][1]||"any",x=this.ih(i.map[b][0]);"function"!=typeof p&&(p=webix.GroupMethods[p]);for(var o=0;o<h.length;o++)h[o][b]=p.call(this,x,this.branch[h[o].id].lh)
}for(var o=0;o<h.length;o++){var v=h[o];if(this.hasEvent("onGroupCreated")&&this.callEvent("onGroupCreated",[v.id,v.value,this.branch[v.id].lh]),i.footer){var w="footer$"+v.id,g=this.pull[w]={id:w,$footer:!0,value:v.value,$level:s,$count:0,$parent:v.id,$row:i.footer.row};for(var b in i.footer){var p=i.footer[b][1]||"any",x=this.ih(i.footer[b][0]);
"function"!=typeof p&&(p=webix.GroupMethods[p]),g[b]=p.call(this,x,this.branch[h[o].id].lh)}this.branch[v.id].push(g.id),this.callEvent("onGroupFooter",[g.id,g.value,this.branch[v.id].lh])}delete this.branch[v.id].lh}this.mh(a,e,s+1),this.callEvent("onStoreUpdated",[])},hh:function(t,e,i){if(i||this.gh){this.gh=Math.max(0,this.gh-1),e=e||0;
...
},ad:"webix_tm_id",on_context:{},on_dblclick:{},on_click:{webix_tree_item:function(t,e){if(this.s.activeTitle){var i=this.getItem(e);i.open?this.close(e):this.open(e)}if(this.s.select)if("multiselect"==this.s.select||this.s.multiselect){if("level"==this.s.multiselect){var s=this.getSelectedId(!0)[0];
if(s&&this.getParentId(e)!=this.getParentId(s))return}this.select(e,!1,t.ctrlKey||t.metaKey||"touch"==this.s.multiselect,t.shiftKey)}else this.select(e)}},rh:{insert:function(t){var e=this.getSelectedId()||"0";this.add({value:t},null,e)},modify:function(t){for(var e=this.getSelectedId(!0),i=0;i<e.length;i++)this.getItem(e[i]).value=t,this.refresh(e[i])
},custom:function(){}},Xg:!0,$dragHTML:function(t){return"<div class='borderless'>"+this.type.template(t,this.type)+"</div>"},type:webix.extend({template:function(t,e){var i=e["template"+t.level]||e.templateCommon;return i.apply(this,arguments)},classname:function(t,e,i){var s="webix_tree_item";return t.$css&&("object"==typeof t.$css&&(t.$css=webix.html.createCss(t.$css)),s+=" "+t.$css),i&&i.$css&&(s+=" "+i.$css),s
...
o.innerHTML=l.join("");for(var u=0;u<l.length;u++)this.t[this.data.getIdByIndex(a+u)]=o.childNodes[u];var d=parseInt(r.style.height,10),f=(s-n)*i.Ei,b=d-f-i.Ei;if(webix.html.insertBefore(o,f?r.nextSibling:r,this.y),this.u[s]=o,o.Ki=!0,0>=f&&b>0)r.style.height=b+"px",this.u[s+1]=r;else if(0>f?webix.html.remove(r):r.style.height=f+"px",b>0){var p=this.u[s+1]=this.Hi(b);
webix.html.insertBefore(p,o.nextSibling,this.y)}s++}if(this.Bi.length){var x=this.Bi[0],v=this.Bi.pop()+1;if(v>x){var w=v-x;if(this.cf(w,x))return;w=Math.max(w,this.s.datafetch||this.s.loadahead||0),this.loadNext(w,x)}}},Ci:function(){var t=this.getScrollState(),e=t.y,i=this.bc,s=this.dc,n=this.type,r=Math.floor(i/n.width)||1,a=Math.floor(e/n.height),h=Math.ceil((s+e)/n.height)-1,o=this.data.$max?this.data.$max-this.data.$min:this.data.count(),l=Math.ceil(o/r)*n.height;
...
}},on_dblclick:{},on_context:{},$init:function(t){this.on_click=webix.extend({},this.on_click);var e="<div class='webix_ss_header'><div class='webix_hs_left'></div><div class='webix_hs_center'></div><div class='webix_hs_right'></div></div><div class='webix_ss_body'><div class='webix_ss_left'><div class='webix_ss_center_scroll'></div></div>";
...
var b="webix_hcell",p=l.css;p&&("object"==typeof p&&(l.css=p=webix.html.createCss(p)),b+=" "+p),this.fj[a].$selected&&(b+=" webix_sel_hcell"),r+="><div class='"+b+"'"+f+">";var x=""===l.text?"&nbsp;":l.text;l.rotate&&(x="<div class='webix_rotate' style='width:"+(d-10)+"px; transform-origin:center "+(d-15)/2+"px;-webkit-transform-origin:center "+(d-15)/2+"px;'>"+x+"</div>"),r+=x+"</div></td>"
...
}},headerContent:[],gk:function(t,e,i){this.oj?(t.style.height=Math.max(e,1)-1+"px",t.style.width=(this.Fj?0:i)+this.oj-1+"px"):t.style.display="none"},Oj:function(){this.s.header&&this.gk(this.hk,this.$g,this.Lj),this.s.footer&&this.gk(this.ik,this.jj,this.Lj)},sk:function(){this.oj=this.s.autoheight||this.s.scrollY===!1?0:webix.ui.scrollSize,this.nj=this.s.autowidth||this.s.scrollX===!1?0:webix.ui.scrollSize,this.Zj&&(this.Zj.x.style.display=this.nj?"block":"none"),this.Wj&&(this.Wj.x.style.display=this.oj?"block":"none")
...
return t&&(e=t.size*t.page,i=Math.min(i,e+t.size)),this.Tj(e,i)},setRowHeight:function(t,e){if(!isNaN(e)){e<this.s.minColumnHeight&&(e=this.s.minColumnHeight);var i=this.getItem(t),s=i.$height||this.s.rowHeight;s!=e&&(i.$height=e,this.config.fixedRowHeight=!1,this.render(),this.callEvent("onRowResize",[t]))
...
if(n)var i=n.page*n.size,s=Math.min(s,i+n.size);if(this.s.autoheight)return[i,s,0];if(t)return[i,s];var r=i,a=this.s.fixedRowHeight?this.s.rowHeight:0;if(a){var h=Math.ceil(e/a);e-=h*a,r+=h}else for(;e>0;)e-=this.Uj(r),r++;var o=r>0?-(this.Uj(r-1)+e):0,l=r;if(e&&r--,e+=this.Vj||this.dc,a){var h=Math.ceil(e/a);
e-=h*a,l+=h,l>s&&(l=s)}else for(;e>0&&s>l;)e-=this.Uj(l),l++;return[r,l,o]},Kv:function(t){var e=this.getItem(t),i=this.getIndexById(t),s=this.Sj();if(!(i<s[0]||i>=s[1]))for(var n=this.Xj(),r=0;r<this.fj.length;r++){var a=this.fj[r];if(r<this.Fj&&r>=this.s.leftSplit&&(r<n[0]||r>n[1])&&(a.qk=-999),a.attached&&a.node){var h=a.node.childNodes[i-s[0]],o=this.Ek(e,this.fj[r],0);
...
},xk:function(t,e,i,s){var n=this.fj[t];if(!n.attached){var r=t<this.s.leftSplit?0:t>=this.Fj?2:1;this.Vf.childNodes[r].firstChild.appendChild(n.node),n.attached=!0,n.split=r}this.ak=e[0],this.ck=0;var a=0;if(this.s.scrollAlignY?e[1]==(this.data.$pagesize||this.data.order.length)?(a=this.ck=e[2],n.node.style.top=a+"px"):n.Jk&&(n.node.style.top="0px"):(this.ck=e[2],e[2]!=n.Jk&&(a=e[2],n.node.style.top=a+"px")),!i&&n.qk==e[0]&&n.Kk==e[1])return 0;
...
var e=this.Yj-this.Gj;0>e&&(e=0),e!=this.Lj&&(this.Lj=e,this.Oj()),this.Zj.sizeTo(this.bc-this.oj),this.Zj.define("scrollWidth",this.Gj+this.dk+this.ek)}}},$getSize:function(t,e){if((this.s.autoheight||this.s.yCount)&&this.s.columns){var i=(this.s.yCount||0)*this.s.rowHeight;i||(i=this.isVisible()?this.wj:this.count()*this.s.rowHeight),this.s.height=Math.max(i+(this.nj?this.nj:0)-1,this.s.minHeight||0)+this.$g+this.jj
}this.s.autowidth&&this.s.columns&&(this.s.width=Math.max(this.Gj+this.dk+this.ek+this.oj,this.s.minWidth||0));var s=this.dk+this.ek+this.oj,n=webix.ui.view.prototype.$getSize.call(this,t,e);return n[0]=Math.max(n[0]||s),n},Ow:function(){if(this.Zj){var t=this.getScrollState();this.Zj.s.scrollPos=this.Wj.s.scrollPos=-1,this.scrollTo(t.x,t.y)
}},$setSize:function(){webix.ui.view.prototype.$setSize.apply(this,arguments)&&(this.tj&&(this.callEvent("onResize",[this.bc,this.dc]),this.Jj(),this.yj()),this.render())},Mk:function(t){var e=this.getColumnConfig(t);if(e.sort){var i="asc";e.id==this.Nk&&(i="asc"==this.Ok?"desc":"asc"),this.zf(e.id,i,e.sort)
}},markSorting:function(t,e){if(this.Pk||(this.Pk=webix.html.create("DIV")),webix.html.remove(this.Pk),e){var i=this.Qk(this.getColumnIndex(t));i&&(this.Pk.className="webix_ss_sort_"+e,i.style.position="relative",i.appendChild(this.Pk)),this.Nk=t,this.Ok=e}else this.Nk=this.Ok=null},scroll_setter:function(t){return"string"==typeof t?(this.s.scrollX=-1!=t.indexOf("x"),this.s.scrollY=-1!=t.indexOf("y"),t):this.s.scrollX=this.s.scrollY=t
},Qk:function(t){for(var e=this.I.getElementsByTagName("TD"),i=null,s=0;s<e.length;s++)if(e[s].getAttribute("column")==t&&!e[s].getAttribute("active_id")&&(i=e[s].firstChild,(e[s].colSpan||0)<2))return i;return i},zf:function(t,e,i){e=e||"asc",this.markSorting(t,e),"server"==i?this.loadNext(-1,0,{before:function(){var t=this.data.url;
this.clearAll(),this.data.url=t}},0,1):("text"==i&&(this.data.each(function(e){e.$text=this.getText(e.id,t)},this),i="string",t="$text"),"function"==typeof i?this.data.sort(i,e):this.data.sort(t,e,i||"string"))},Yc:function(t,e,i,s){t=t||event;for(var n=t.target||t.srcElement,r=[],a="",h=null,o=!1;n&&n.parentNode;){if(a=n.className){a=a.split(" ");
for(var l=a.length-1;l>=0;l--)e[a[l]]&&r.push(e[a[l]])}if(n.parentNode.getAttribute){var c=n.parentNode.getAttribute("column")||n.getAttribute("column");if(c){var u="DIV"==n.parentNode.tagName;if(o=!0,u){var d=n.parentNode.getAttribute("row")||n.getAttribute("row")||webix.html.index(n)+this.fj[c].qk;
this.Qc=h={row:this.data.order[d],column:this.fj[c].id},h.toString=this.ok}else this.Qc=h={column:this.fj[c].id};if(r.length)for(var l=0;l<r.length;l++){var f=webix.toFunctor(r[l],this.$scope),b=f.call(this,t,h,n);if(b===!1)return}if(u)this.callEvent("on"+i,[h,t,n])&&s&&this.callEvent("on"+s,[h,t,n]);
else if("ItemClick"==i){var p="header"==n.parentNode.parentNode.getAttribute("section");p&&this.callEvent("onHeaderClick",[h,t,n])&&this.Mk(h.column)}break}}n=n.parentNode}return o},showOverlay:function(t){if(!this.Rk){var e=webix.html.create("DIV",{"class":"webix_overlay"},"");this.Vf.appendChild(e),this.Rk=e
}this.Rk.innerHTML=t},hideOverlay:function(){this.Rk&&(webix.html.remove(this.Rk),this.Rk=null)},mapCells:function(t,e,i,s,n){if(null===t&&this.data.order.length>0&&(t=this.data.order[0]),null===e&&(e=this.columnId(0)),null===i&&(i=this.data.order.length),null===s&&(s=this.s.columns.length),this.exists(t)&&(t=this.getIndexById(t),e=this.getColumnIndex(e),null!==e))for(var r=0;i>r&&t+r<this.data.order.length;r++)for(var a=t+r,h=this.data.order[a],o=this.getItem(h),l=0;s>l&&e+l<this.s.columns.length;l++){var c=e+l,u=this.columnId(c);
...
o[d]=t(o[d],a[r],d,h,c),c++}}h++}}}}},row:{Lk:" webix_row_select",fl:function(t){return t.row},select:function(t,e){this.hl({row:t},e)},kl:function(t){return this.nl(t.row).$row=!0,t.row},unselect:function(t){this.ll({row:t})},ml:function(t){return this.data.removeMark(t.row,"webix_selected",0,1),t.row
...
},_l:function(t){for(var e=document.cookie.split(";"),i="",s="",n="",r=!1,a=0;a<e.length;a++){if(i=e[a].split("="),s=i[0].replace(/^\s+|\s+$/g,""),s==t)return r=!0,i.length>1&&(n=unescape(i[1].replace(/^\s+|\s+$/g,""))),n;i=null,s=""}return r?null:null},get:function(t){if(t&&window.JSON){var e=this._l(t);
return e?webix.DataDriver.json.toObject(e):null}return null},remove:function(t,e){t&&this._l(t)&&(document.cookie=t+"="+(e?";domain="+e:"")+";expires=Thu, 01-Jan-1970 00:00:01 GMT")},clear:function(t){for(var e=document.cookie.split(";"),i=0;i<e.length;i++)document.cookie=/^[^=]+/.exec(e[i])[0]+"="+(t?";domain="+t:"")+";expires=Thu, 01-Jan-1970 00:00:01 GMT"
...
else if(t.ym&&!t.zm)t.Gm("onSwipeY");else if(webix.env.isSafari&&t.im){t.im=!1;var p=t.km.target;webix.delay(function(){var t=document.createEvent("MouseEvents");t.initEvent("click",!0,!0),p.dispatchEvent(t)})}t.Gm("onTouchEnd"),t.Of()}},em:function(e){if(t.km){var i=t.Bm(e);if(t.Gm("onTouchMove"),t.nm)t.Hm(i);
...
}(),webix.attachEvent("onDataTable",function(t,e){webix.env.touch&&(webix.Touch.$init(),e.scrollSize=0,webix.extend(t,e.prerender===!0?t.Vm:t.Wm))}),webix.extend(webix.ui.datatable,{Vm:{$j:function(t,e){webix.Touch.Nf(this.Vf.childNodes[1].firstChild,0,0,"0ms"),this.Em(t,e,"0ms")},_j:function(){var t=webix.Touch.Mf(this.Vf.childNodes[1].firstChild);
return{x:-t.e,y:-t.f}},$init:function(){webix.Touch.limit(),this.defaults.scrollAlignY=!1,this.Vf.setAttribute("touch_scroll","xy"),this.attachEvent("onBeforeScroll",function(){webix.Touch.om=this.Vf.childNodes[1].firstChild,webix.Touch.Um(webix.Touch.om),webix.Touch.Dm=this}),this.attachEvent("onTouchEnd",function(){webix.Touch.Dm=null
}),webix.Touch.Nm(this.Vf.childNodes[1].firstChild),webix.Touch.Nf(this.Vf.childNodes[1].firstChild,0,0,"0ms"),this.Em(0,0,"0ms")},Em:function(t,e,i){this.s.leftSplit&&webix.Touch.Nf(this.Vf.childNodes[0].firstChild,0,e,i),this.s.rightSplit&&webix.Touch.Nf(this.Vf.childNodes[2].firstChild,0,e,i),this.s.header&&webix.Touch.Nf(this.I.childNodes[1].firstChild,t,0,i),this.s.footer&&webix.Touch.Nf(this.cj.childNodes[1].firstChild,t,0,i),this.callEvent("onSyncScroll",[t,e,i])
},Mm:function(){}},Wm:{$j:function(t,e){webix.delay(function(){this.callEvent("onAfterScroll",[{e:-t,f:-e}])},this)},$scroll:{gravity:0,elastic:!1},$init:function(){webix.Touch.limit(),this.defaults.scrollAlignY=!1,this.Vf.setAttribute("touch_scroll","xy"),this.attachEvent("onBeforeScroll",function(){var t=webix.Touch;
t.om=this.Vf.childNodes[1].firstChild,t.Um(t.om),t.pm.dy=this.wj,t.Dm=this}),this.attachEvent("onAfterScroll",function(t){webix.Touch.Dm=null,webix.Touch.$m=null,this.jk=0;var e=webix.Touch.config.translate;return webix.Touch.config.translate="translate",this.Em(t.e,0,"0ms"),webix.Touch.config.translate=e,this.bk=-t.e,this.jk=-t.f,this.render(),!1
}),webix.Touch.Nm(this.Vf.childNodes[1].firstChild),webix.Touch.Nf(this.Vf.childNodes[1].firstChild,0,0,"0ms"),this.Em(0,0,"0ms")},Em:function(t,e,i){e+=this.jk,webix.Touch.Nf(this.Vf.childNodes[1].firstChild,t,e,i),this.s.leftSplit&&webix.Touch.Nf(this.Vf.childNodes[0].firstChild,0,e,i),this.s.rightSplit&&webix.Touch.Nf(this.Vf.childNodes[2].firstChild,0,e,i),this.s.header&&webix.Touch.Nf(this.I.childNodes[1].firstChild,t,0,i),this.s.footer&&webix.Touch.Nf(this.cj.childNodes[1].firstChild,t,0,i),this.callEvent("onSyncScroll",[t,e,i])
...
var o=this.getColumnIndex(h),l=this.getColumnIndex(a.column);e.touches&&(this.ny=e.target,this.ny.style.display="none",this.$view.parentNode.appendChild(this.ny)),this.moveColumn(h,l+(l>o?1:0)),this.Yg=a.column,this.Sn=!0}if(a&&a.column==h&&(this.Sn=!1),i.style.display="block",t.x=t.x-this.Qn.x,t.y=n.y,t.x<n.x)t.x=n.x;
else{var c=n.x+this.$view.offsetWidth-this.oj-this.Rn;t.x>c&&(t.x=c)}webix.DragControl.Ed=!0},this),$dragDestroy:webix.bind(function(t,e){webix.html.remove(e),this.ny&&webix.html.remove(this.ny);var i=webix.DragControl.getContext().start;this.callEvent("onAfterColumnDropOrder",[i.column,this.Yg,t])},this)}:t&&(e={ah:!0,$drag:webix.bind(function(t,i){var s=this.locate(i);
...
}},webix.TreeAPI,webix.TreeStateCheckbox,webix.TreeDataLoader,webix.ui.datatable),webix.extend(webix.ui.datatable,{spans_setter:function(t){return t&&!this.Rt&&this.Qt(),t},Qt:function(){this.Rt={},this.St=[],this.data.attachEvent("onStoreLoad",webix.bind(function(t,e){e&&e.spans&&this.addSpan(e.spans)
},this)),this.attachEvent("onClearAll",function(){this.Rt={}}),this.attachEvent("onScrollY",this.Tt),this.attachEvent("onScrollX",this.Tt),this.data.attachEvent("onStoreUpdated",webix.bind(function(t,e,i){"paint"!=i&&this.fj.length&&this.Ut()},this)),this.attachEvent("onStructureLoad",this.Ut),this.attachEvent("onStructureUpdate",this.Ut),this.attachEvent("onColumnResize",this.Ut),this.attachEvent("onRowResize",this.Ut),this.attachEvent("onSelectChange",this.Vt)
},addSpan:function(t,e,i,s,n,r){if("object"!=typeof t)s=s||1,i=i||1,this.Rt[t]||(this.Rt[t]={}),this.Rt[t][e]=[i,s,n,r];else for(var a=0;a<t.length;a++)this.addSpan.apply(this,t[a])},removeSpan:function(t,e){var i=this.Rt[t];i&&delete i[e]},Ut:function(){webix.html.remove(this.St);for(var t=0;3>t;t++){var e=this.St[t]=webix.html.create("DIV",{"class":"webix_span_layer"});
this.Vf.childNodes[t].appendChild(e)}this.Tt(),this.s.leftSplit&&this.Wt(this.St[0],0,this.s.leftSplit),this.s.rightSplit&&this.Wt(this.St[2],this.Fj,this.fj.length),this.Wt(this.St[1],this.s.leftSplit,this.Fj||this.fj.length)},Wt:function(t,e,i){for(var s=0,n=this.data.order.length,r=0;n>r;r++){var a=this.data.order[r],h=this.Rt[a];
if(h)for(var o=e;i>o;o++){var l=this.fj[o].id;h[l]&&this.Xt(t,r,o,h,s,e,a,l)}s+=this.getItem(a).$height||this.s.rowHeight}},Vt:function(){for(var t=this.config.select,e="cell"==t||"column"==t,i=this.getSelectedId(!0),s=this.Yt||[],n=webix.uid()+"",r=!1,a=0;a<i.length;a++){var h=this.Rt[i[a]];!h||e&&!h[i[a].column]||(h.$selected||(r=!0),h.$selected=n)
}for(var a=0;a<s.length;a++){var h=this.Rt[s[a]];h&&h.$selected!==n&&(h.$selected="",r=!0)}this.Yt=[].concat(i),r&&this.Ut()},Zt:function(t,e){for(var i=0,s=t;e>s;s++){var n=this.fj[s];i+=n?n.width:0}return i},$t:function(t,e){for(var i=0,s=t;e>s;s++){var n=this.getItem(this.data.order[s]);i+=(n?n.$height:0)||this.s.rowHeight
}return i},Xt:function(t,e,i,s,n,r,a,h){var o=s[h],l=o[2]||this.getText(a,h),c=s.$selected?"webix_selected ":"",u=webix.html.create("DIV",{column:i,row:e,"class":c+"webix_cell webix_table_cell webix_dtable_span "+(o[3]||"")},l);u.style.top=n+"px",u.style.left=this.Zt(r,i)+"px",u.style.width=this.Zt(i,i+o[0])+"px",u.style.height=this.$t(e,e+o[1])+"px",t.appendChild(u)
},Tt:function(){for(var t=this.getScrollState(),e=0;3>e;e++)this.St[e].style.top="-"+t.y+"px"}}),webix.extend(webix.ui.datatable,{headermenu_setter:function(t){return t&&(t.data&&(this.Xw=!0),t=this._t(t)),t},_t:function(t){var e={view:"contextmenu",template:"<span class='webix_icon {common.hidden()}'></span> &nbsp; #value#",type:{hidden:function(t){return t.hidden?"fa-empty":"fa-eye"
}},on:{onMenuItemClick:webix.bind(function(t){var e=webix.$$(this.s.headermenu),i=e.getItem(t).hidden;return e.getItem(t).hidden=!i,e.refresh(t),e.$blockRender=!0,i?this.showColumn(t):this.hideColumn(t),e.$blockRender=!1,!1},this)},data:[]};"object"==typeof t&&webix.extend(e,t,!0);var i=webix.ui(e);return i.attachTo(this.I),this.Ns.push(i),this.attachEvent("onStructureLoad",this.au),this.attachEvent("onStructureUpdate",this.au),this._t=function(t){return t
},i.s.id},au:function(){var t=webix.$$(this.s.headermenu);if(!t.$blockRender&&!this.Xw){for(var e=[],i=0;i<this.fj.length;i++){var s=this.fj[i];s.headermenu!==!1&&e.push({id:s.id,value:s.header[0].text})}for(var n=this.getState().hidden,i=n.length-1;i>=0;i--)e.push({id:n[i],value:this.getColumnConfig(n[i]).header[0].text,hidden:1});
e.length&&t.data.importData(e)}}}),webix.ui.datafilter.headerMenu={getValue:function(){},setValue:function(){},refresh:function(t,e){t.s.headermenu||(t.define("headermenu",!0),t.au()),e.onclick=function(){webix.$$(t.config.headermenu).show(e)}},render:function(){return"<span class='webix_icon fa-columns'>"
}},webix.ui.datafilter.richSelectFilter=webix.ui.datafilter.controlFilter={getInputNode:function(t){return webix.$$(t.$webix)},getValue:function(t){return webix.$$(t.$webix).getValue()},setValue:function(t,e){webix.$$(t.$webix).setValue(e)},prepare:function(t,e){if(!t)return t;for(var i={},s=t.toString().split(e.separator||","),n=0;n<s.length;n++)i[s[n]]=1;
return i},compare:function(t,e){return!e||e[t]},refresh:function(t,e,i){var s=webix.$$(i.richselect);if(!s.$view.parentNode){var n=webix.html.create("div",{"class":"webix_richfilter"});n.appendChild(s.$view)}e.$webix=i.richselect,e.style.marginLeft="-10px",i.compare=i.compare||this.compare,i.prepare=i.prepare||this.prepare,t.registerFilter(e,i,this);
var r;r=i.options?i.options:t.collectValues(i.columnId).slice(1);var a=s.getPopup().getList();a.parse&&(a.clearAll(),a.parse(r)),i.value&&this.setValue(e,i.value),e.firstChild.appendChild(s.$view.parentNode),s.render(),webix.delay(s.resize,s)},render:function(t,e){if(!e.richselect){var i=webix.html.create("div",{"class":"webix_richfilter"}),s={container:i,view:this.inputtype,options:[]};
e.separator&&(s.separator=e.separator);var n=webix.ui(s);n.attachEvent("onChange",function(){t.filterByAll()}),e.richselect=n.s.id,t.Ns.push(n)}return e.css="webix_div_filter"," "},inputtype:"richselect"},webix.ui.datafilter.multiSelectFilter=webix.extend({inputtype:"multiselect"},webix.ui.datafilter.richSelectFilter),webix.ui.datafilter.datepickerFilter=webix.extend({prepare:function(t){return t||""
},compare:function(t,e){return 1*t==1*e},inputtype:"datepicker"},webix.ui.datafilter.richSelectFilter),webix.ui.datafilter.columnGroup={getValue:function(){},setValue:function(){},getHelper:function(t,e){return{open:function(){e.closed=!1,t.onclick()},close:function(){e.closed=!0,t.onclick()},isOpened:function(){return e.closed
}}},refresh:function(t,e,i){function s(e,i){t.eachColumn(function(s,n){n.batch&&n.batch==e&&(i&&t.am[n.id]?t.hideColumn(n.id,!1,!0):i||t.am[n.id]||t.hideColumn(n.id,!0,!0))},!0),t.On()}e.onclick=function(){var t=this.firstChild.firstChild;i.closed?(i.closed=!1,t.className="webix_tree_open",webix.delay(s,this,[i.batch,!0])):(i.closed=!0,t.className="webix_tree_close",webix.delay(s,this,[i.batch,!1]))
},i.firstRun||(i.firstRun=1,i.closed=!i.closed,webix.delay(e.onclick,e))},render:function(t,e){return"<div class='"+(e.closed?"webix_tree_close":"webix_tree_open")+"'></div>&nbsp;"+(e.groupText||"")}},webix.Canvas=webix.proto({$init:function(t){this.Wn=[],this.Xn=t.name,this.tg=webix.toNode(t.container||t);
var e=t.width*(window.devicePixelRatio||1),i=t.height*(window.devicePixelRatio||1),s=t.style||"";s+=";width:"+t.width+"px;height:"+t.height+"px;",this.Yn(t.name,s,e,i)},Yn:function(t,e,i,s){return this.Zn=webix.html.create("canvas",{width:i,height:s,canvas_id:t,style:e||""}),this.tg.appendChild(this.Zn),this.Zn.getContext||webix.env.isIE&&(webix.require("legacy/excanvas/excanvas.js"),G_vmlCanvasManager.init_(document),G_vmlCanvasManager.initElement(this.Zn)),this.Zn
...
for(var d=(l-c)*a/(r-n),f=0,b=n;r>=b;b+=a){var p=this.Bo?Math.pow(10,b):b;h.fixNum&&(p=parseFloat(p).toFixed(h.fixNum));var x=Math.floor(l-f*d)+.5;if(b==n&&"auto"==this.s.origin||!this.s.yAxis.lines.call(this,b)||this.zo(t,o,x,s.x,x,this.s.yAxis.lineColor.call(this,b),1),b==this.s.origin&&(u=x),1>a&&!this.Bo){var v=Math.min(Math.floor(this.Do(a)),0>=n?0:Math.floor(this.Do(n))),w=Math.pow(10,-v);
p=Math.round(p*w)/w,b=p}this.canvases.y.renderText(0,x-5,this.s.yAxis.template(p.toString()),"webix_axis_item_y",i.x-5),f++}return this.zo(t,o,l+1,o,c,this.s.yAxis.color,1),u}}},Co:function(t,e){var i="webix_axis_title_y"+(webix.Eo&&9!=webix.Eo?" webix_ie_filter":""),s=this.canvases.y.renderTextAt("middle",!1,0,parseInt((e.y-t.y)/2+t.y,10),this.s.yAxis.title,i);
...
0>t&&(r=-r-2*n)}for(a=r;e>a;)a+=n,a=parseFloat((1*a).toFixed(Math.abs(h)));return{start:r,end:a,step:n,fixNum:Math.abs(h)}},Go:function(t,e){var i,s,n=this.data.Df(),r=arguments.length&&"h"==t?this.so:this.to;if(e=e||"value",r&&"undefined"!=typeof r.end&&"undefined"!=typeof r.start&&r.step)i=parseFloat(r.end),s=parseFloat(r.start);
...
1==n&&this.s.shadow&&this.Xo(t,d,f,o),f/=n;var b=-Math.PI/2,p=[];if(t.scale(1,n),this.s.gradient){var x=1!=n?d+o/3:d,v=1!=n?f+o/3:f;this.Yo(t,d,f,o,x,v)}for(var w=0;w<e.length;w++)if(l[w]){t.strokeStyle=this.s.lineColor.call(this,e[w]),t.beginPath(),t.moveTo(d,f),p.push(b);var g=-Math.PI/2+u[w]-1e-4;
...
},Zo:function(t,e,i,s,n,r,a,h){var o=this.canvases[0].renderText(0,0,a,0,1);if(o){var l=o.scrollWidth;o.style.width=l+"px",l>t&&(l=t);var c=.2>n-s?4:8;h&&(c=l/1.8);var u=s+(n-s)/2;i-=(c-8)/2;var d=-c,f=-8,b="right";(u>=Math.PI/2&&u<Math.PI||u<=3*Math.PI/2&&u>=Math.PI)&&(d=-l-d+1,b="left");var p=0;!h&&1>r&&u>0&&u<Math.PI&&(p=(this.s.height||Math.floor(i/4))/r);
var x=(e+Math.floor((i+p)*Math.sin(u)))*r+f,v=t+Math.floor((i+c/2)*Math.cos(u))+d,w=n<Math.PI/2+.01,g=s<Math.PI/2;g&&w?v=Math.max(v,t+3):g||w?!h&&(u>=Math.PI/2&&u<Math.PI||u<=3*Math.PI/2&&u>=Math.PI)&&(v+=l/3):v=Math.min(v,t-l),o.style.top=x+"px",o.style.left=v+"px",o.style.width=l+"px",o.style.textAlign=b,o.style.whiteSpace="nowrap"
...
}}}),webix.extend(webix.ui.chart,{$render_bar:function(t,e,i,s,n,r){var a,h,o,l,c,u,d,f,b,p,x,v,w,g=s.y-i.y;w=!!this.s.yAxis,v=!!this.s.xAxis,l=this.Go(),c=l.max,u=l.min,h=(s.x-i.x)/e.length,n||"auto"!=this.s.origin&&!w||this.uo(e,i,s,u,c,h),w&&(c=parseFloat(this.s.yAxis.end),u=parseFloat(this.s.yAxis.start)),b=this.Ho(u,c),d=b[0],f=b[1],x=d?g/d:d,w||"auto"!=this.s.origin&&v||(p=10,x=d?(g-p)/d:p),!n&&"auto"!=this.s.origin&&!w&&this.s.origin>u&&this.wo(t,e,i,s,h,s.y-x*(this.s.origin-u)),a=parseInt(this.s.barWidth,10);
var m=0,y=0;for(o=0;o<this.go.length;o++)o==n&&(y=m),"bar"==this.go[o].type&&m++;this.go&&a*m+4>h&&(a=parseInt(h/m-4,10));var _=(h-a*m)/2,$="undefined"!=typeof this.s.radius?parseInt(this.s.radius,10):Math.round(a/5),k=!1,S=this.s.gradient;for(S&&"function"!=typeof S?(k=S,S=!1):S&&(S=t.createLinearGradient(0,s.y,0,i.y),this.s.gradient(S)),v||this.zo(t,i.x,s.y+.5,s.x,s.y+.5,"#000000",1),o=0;o<e.length;o++){var I=parseFloat(this.s.value(e[o])||0);
if(this.Bo&&(I=this.Do(I)),!isNaN(I)){I>c&&(I=c),I-=u,I*=f;var C=i.x+_+o*h+(a+1)*y,E=s.y;if(0>I||this.s.yAxis&&0===I&&!("auto"!=this.s.origin&&this.s.origin>u))this.canvases[n].renderTextAt(!0,!0,C+Math.floor(a/2),E,this.s.label(e[o]));else{w||"auto"!=this.s.origin&&v||(I+=p/x);var M=S||this.s.color.call(this,e[o]);
t.globalAlpha=this.s.alpha.call(this,e[o]);var j=this.bp(t,i,C,E,a,u,$,x,I,M,S,k);k&&this.cp(t,C,E,a,u,$,x,I,M,k),this.s.border&&this.dp(t,C,E,a,u,$,x,I,M),t.globalAlpha=1,j[0]!=C?this.canvases[n].renderTextAt(!1,!0,C+Math.floor(a/2),j[1],this.s.label(e[o])):this.canvases[n].renderTextAt(!0,!0,C+Math.floor(a/2),j[3],this.s.label(e[o])),r.addRect(e[o].id,[C-i.x,j[3]-i.y,j[2]-i.x,j[1]-i.y],n)
...
var d=this.ep(t,i,s,o,h,n,r),f=this.fp(t,d.x0,d.y0,n,a,h,d.value,this.s.border?1:0);c&&!u&&t.lineTo(d.x0+(this.s.border?1:0),e.y),t.fill(),t.restore();var b=d.x0,p=d.x0!=i?i+f[0]:f[0],x=d.x0!=i?d.start-f[1]-d.y0:d.y0,v=d.x0!=i?d.start-d.y0:f[1];return[b,x,p,v]},gp:function(t,e){var i,s;s=webix.color.toRgb(e),i=webix.color.rgbToHsv(s[0],s[1],s[2]),i[2]/=1.4,e="rgb("+webix.color.hsvToRgb(i[0],i[1],i[2])+")",t.strokeStyle=e,1==t.globalAlpha&&(t.globalAlpha=.9)
...
var d=e+n;n&&n>0&&t.arc(d,u,n-h,-Math.PI+l,-Math.PI/2,!1);var f=e+s-n-h,b=u-n+(n?h:0);t.lineTo(f,b),n&&n>0&&t.arc(f+h,u,n-h,-Math.PI/2,0-l,!1);var p=e+s-h;return t.lineTo(p,i),o||t.lineTo(e+h,i),[p,b]}}),webix.extend(webix.ui.chart,{$render_line:function(t,e,i,s,n,r){var a,h,o,l,c,u,d,f,b,p,x,v;if(l=this.hp(t,e,i,s,n),a=this.s,e.length){for(c=a.offset?i.x+.5*l.cellWidth:i.x,o=[],h=0;h<e.length;h++)if(v=this.ip(e[h],i,s,l)){if(d=h?l.cellWidth*h-.5+c:c,b="object"==typeof v?v.y0:v,h&&this.s.fixOverflow){if(x=this.ip(e[h-1],i,s,l),x.out&&x.out==v.out)continue;
u=l.cellWidth*(h-1)-.5+c,f="object"==typeof x?x.y0:x,x.out&&(p="min"==x.out?s.y:i.y,o.push({x:this.jp(u,d,f,b,p),y:p})),v.out&&(p="min"==v.out?s.y:i.y,o.push({x:this.jp(u,d,f,b,p),y:p}))}v.out||o.push({x:d,y:v,index:h})}for(this.kp=i,h=1;h<=o.length;h++)u=o[h-1].x,f=o[h-1].y,h<o.length&&(d=o[h].x,b=o[h].y,this.zo(t,u,f,d,b,a.line.color.call(this,e[h-1]),a.line.width),a.line&&a.line.shadow&&(t.globalAlpha=.3,this.zo(t,u+2,f+a.line.width+8,d+2,b+a.line.width+8,"#eeeeee",a.line.width+3),t.globalAlpha=1)),"undefined"!=typeof o[h-1].index&&this.lp(t,u,f,e[o[h-1].index],a.label(e[o[h-1].index]),n,r,i)
...
var l=this.Ho(a.minValue,a.maxValue);return r=l[0],a.valueFactor=l[1],a.unit=r?a.totalHeight/r:10,a.startValue=0,h||(a.startValue=10,a.unit!=a.totalHeight&&(a.unit=r?(a.totalHeight-a.startValue)/r:10)),a}}),webix.extend(webix.ui.chart,{$render_barH:function(t,e,i,s,n,r){var a,h,o,l,c,u,d,f,b,p,x,v,w,g,m,y,_,$,k,S,I;
for(o=(s.y-i.y)/e.length,d=this.Go("h"),f=d.max,b=d.min,y=s.x-i.x,I=!!this.s.yAxis,n||this.mp(t,e,i,s,b,f,o),I&&(f=parseFloat(this.s.xAxis.end),b=parseFloat(this.s.xAxis.start)),g=this.Ho(b,f),v=g[0],x=g[1],$=v?y/v:10,I||(m=10,$=v?(y-m)/v:10),h=parseInt(this.s.barWidth,10),h*this.go.length+4>o&&(h=o/this.go.length-4),a=Math.floor((o-h*this.go.length)/2),w="undefined"!=typeof this.s.radius?parseInt(this.s.radius,10):Math.round(h/5),p=!1,c=this.s.gradient,c&&"function"!=typeof c?(p=c,c=!1):c&&(c=t.createLinearGradient(i.x,i.y,s.x,i.y),this.s.gradient(c)),I||this.zo(t,i.x-.5,i.y,i.x-.5,s.y,"#000000",1),u=0;u<e.length;u++)if(_=parseFloat(this.s.value(e[u]||0)),this.Bo&&(_=this.Do(_)),_>f&&(_=f),_-=b,_*=x,k=i.x,S=i.y+a+u*o+(h+1)*n,0>_&&"auto"==this.s.origin||this.s.xAxis&&0===_&&!("auto"!=this.s.origin&&this.s.origin>b))this.canvases[n].renderTextAt("middle","right",k+10,S+h/2+a,this.s.label(e[u]));
else{0>_&&"auto"!=this.s.origin&&this.s.origin>b&&(_=0),I||(_+=m/$),l=c||this.s.color.call(this,e[u]),this.s.border&&this.np(t,k,S,h,b,w,$,_,l),t.globalAlpha=this.s.alpha.call(this,e[u]);var C=this.op(t,s,k,S,h,b,w,$,_,l,c,p);p&&this.pp(t,k,S,h,b,w,$,_,l,p),t.globalAlpha=1,C[3]==S?(this.canvases[n].renderTextAt("middle","left",C[0]-5,C[3]+Math.floor(h/2),this.s.label(e[u])),r.addRect(e[u].id,[C[0]-i.x,C[3]-i.y,C[2]-i.x,C[3]+h-i.y],n)):(this.canvases[n].renderTextAt("middle",!1,C[2]+5,C[1]+Math.floor(h/2),this.s.label(e[u])),r.addRect(e[u].id,[C[0]-i.x,S-i.y,C[2]-i.x,C[3]-i.y],n))
}},qp:function(t,e,i,s,n,r,a,h,o){var l=0;if(n>r*a){var c=(n-r*a)/n;l=-Math.asin(c)+Math.PI/2}t.moveTo(e,i+h);var u=e+r*a-n-(n?0:h);r*a>n&&t.lineTo(u,i+h);var d=i+n;n&&n>0&&t.arc(u,d,n-h,-Math.PI/2+l,0,!1);var f=i+s-n-(n?0:h),b=u+n-(n?h:0);t.lineTo(b,f),n&&n>0&&t.arc(u,f,n-h,0,Math.PI/2-l,!1);var p=i+s-h;
return t.lineTo(e,p),o||t.lineTo(e,i+h),[b,p]},mp:function(t,e,i,s,n,r,a){var h=0;this.s.xAxis&&(this.canvases.x||(this.canvases.x=this.lo("axis_x")),h=this.rp(this.canvases.x.getCanvas(),e,i,s,n,r)),this.s.yAxis&&(this.canvases.y||(this.canvases.y=this.lo("axis_y")),this.sp(this.canvases.y.getCanvas(),e,i,s,a,h))
...
}this.zo(t,i.x+.5,l+.5,s.x,l+.5,this.s.yAxis.lineColor.call(this,{}),1),this.Co(i,s)}},rp:function(t,e,i,s,n,r){var a,h={},o=this.s.xAxis;if(o){var l=s.y+.5,c=i.x-.5,u=s.x-.5,d=i.x;if(this.zo(t,c,l,u,l,o.color,1),o.step&&(a=parseFloat(o.step)),("undefined"==typeof this.so.step||"undefined"==typeof this.so.start||"undefined"==typeof this.so.end)&&(h=this.Ao(n,r),n=h.start,r=h.end,a=h.step,this.s.xAxis.end=r,this.s.xAxis.start=n,this.s.xAxis.step=a),0!==a){for(var f=(u-c)*a/(r-n),b=0,p=n;r>=p;p+=a){var x=this.Bo?Math.pow(10,p):p;
h.fixNum&&(x=parseFloat(x).toFixed(h.fixNum));var v=Math.floor(c+b*f)+.5;if(p==n&&"auto"==this.s.origin||!o.lines.call(this,p)||this.zo(t,v,l,v,i.y,this.s.xAxis.lineColor.call(this,p),1),p==this.s.origin&&(d=v+1),1>a&&!this.Bo){var w=Math.min(Math.floor(this.Do(a)),0>=n?0:Math.floor(this.Do(n))),g=Math.pow(10,-w);
x=Math.round(x*g)/g,p=x}this.canvases.x.renderTextAt(!1,!0,v,l+2,o.template(x.toString()),"webix_axis_item_x"),b++}return this.canvases.x.renderTextAt(!0,!1,c,s.y+this.s.padding.bottom-3,this.s.xAxis.title,"webix_axis_title_x",s.x-i.x),o.lines.call(this,{})||this.zo(t,c,i.y-.5,u,i.y-.5,this.s.xAxis.color,.2),d
...
t.fillStyle=l,t.beginPath();var f=this.qp(t,d.x0,d.y0,n,a,h,d.value,this.s.border?1:0);c&&!u&&t.lineTo(e.x,d.y0+(this.s.border?1:0)),t.fill(),t.restore();var b=d.y0,p=d.y0!=s?s:f[1],x=d.y0!=s?d.start-f[0]:d.start,v=d.y0!=s?d.start:f[0];return[x,b,v,p]},np:function(t,e,i,s,n,r,a,h,o){t.save();var l=this.tp(t,e,i,h,a,s,n);
...
}}),webix.extend(webix.ui.chart,{$render_stackedBar:function(t,e,i,s,n,r){var a,h,o,l,c=s.y-i.y,u=!!this.s.yAxis,d=!!this.s.xAxis,f=this.No(e);a=f.max,h=f.min;var b=Math.floor((s.x-i.x)/e.length);n||this.uo(e,i,s,h,a,b),u&&(a=parseFloat(this.s.yAxis.end),h=parseFloat(this.s.yAxis.start));var p=this.Ho(h,a);
l=p[0],o=p[1];var x=l?c/l:10,v=parseInt(this.s.barWidth,10);v+4>b&&(v=b-4);var w=Math.floor((b-v)/2),g=this.s.gradient?this.s.gradient:!1;d||this.zo(t,i.x,s.y+.5,s.x,s.y+.5,"#000000",1);for(var m=0;m<e.length;m++){var y=parseFloat(this.s.value(e[m]||0));if(this.Bo&&(y=this.Do(y)),y){n||(y-=h),y*=o;var _=i.x+w+m*b,$=s.y;
if(n?$=e[m].$startY:e[m].$startY=$,!($<i.y+1))if(0>y||this.s.yAxis&&0===y)this.canvases.y.renderTextAt(!0,!0,_+Math.floor(v/2),$,this.s.label(e[m]));else{var k=this.s.color.call(this,e[m]);t.globalAlpha=this.s.alpha.call(this,e[m]),t.fillStyle=this.s.color.call(this,e[m]),t.beginPath();var S=this.up(t,_-(this.s.border?.5:0),$,v+(this.s.border?.5:0),x,y,0,i.y);
if(t.fill(),g){t.save();var I=this.Oo(t,_,$,_+v,S[1],g,k,"y");t.fillStyle=I.gradient,t.beginPath(),S=this.up(t,_+I.offset,$,v-2*I.offset,x,y,this.s.border?1:0,i.y),t.fill(),t.restore()}this.s.border&&(t.save(),this.gp(t,k),t.beginPath(),this.up(t,_-.5,$,v+1,x,y,0,i.y,1),t.stroke(),t.restore()),t.globalAlpha=1,this.canvases[n].renderTextAt(!1,!0,_+Math.floor(v/2),S[1]+($-S[1])/2-7,this.s.label(e[m])),r.addRect(e[m].id,[_-i.x,S[1]-i.y,S[0]-i.x,(e[m].$startY||$)-i.y],n),e[m].$startY=this.s.border?S[1]+1:S[1]
...
a=d.max,h=d.min;var f=Math.floor((s.y-i.y)/e.length);n||this.mp(t,e,i,s,h,a,f),u&&(a=parseFloat(this.s.xAxis.end),h=parseFloat(this.s.xAxis.start));var b=this.Ho(h,a);l=b[0],o=b[1];var p=l?c/l:10,x=0;u||(x=10,p=l?(c-x)/l:10);var v=parseInt(this.s.barWidth,10);v+4>f&&(v=f-4);var w=(f-v)/2,g=0,m=!1,y=this.s.gradient;
y&&(m=!0),u||this.zo(t,i.x-.5,i.y,i.x-.5,s.y,"#000000",1);var _=0,$=0;for(k=0;k<this.go.length;k++)k==n&&($=_),"stackedBarH"==this.go[k].type&&_++;for(var k=0;k<e.length;k++){$||(e[k].$startX=i.x);var S=parseFloat(this.s.value(e[k]||0));S>a&&(S=a),S-=h,S*=o;var I=i.x,C=i.y+w+k*f;if($?I=e[k].$startX:e[k].$startX=I,0>S||this.s.yAxis&&0===S)this.canvases.y.renderTextAt("middle",!0,I+10,C+v/2,this.s.label(e[k]));
else{u||(S+=x/p);var E=this.s.color.call(this,e[k]);t.globalAlpha=this.s.alpha.call(this,e[k]),t.fillStyle=this.s.color.call(this,e[k]),t.beginPath();var M=this.qp(t,I,C,v,g,p,S,this.s.border?1:0);if(y&&!m&&t.lineTo(i.x+c,C+(this.s.border?1:0)),t.fill(),m){var j=this.Oo(t,I,C+v,I,C,m,E,"x");t.fillStyle=j.gradient,t.beginPath(),M=this.qp(t,I,C,v,g,p,S,0),t.fill()
}this.s.border&&this.np(t,I,C,v,h,g,p,S,E),t.globalAlpha=1,this.canvases[n].renderTextAt("middle",!0,e[k].$startX+(M[0]-e[k].$startX)/2-1,C+(M[1]-C)/2,this.s.label(e[k])),r.addRect(e[k].id,[e[k].$startX-i.x,C-i.y,M[0]-i.x,M[1]-i.y],n),e[k].$startX=M[0]}}}}),webix.extend(webix.ui.chart,{$render_spline:function(t,e,i,s,n,r){var a,h,o,l,c,u,d,f,b,p,x,v,w;
if(c=this.hp(t,e,i,s,n),a=this.s,this.kp=i,o=[],e.length){for(f=a.offset?i.x+.5*c.cellWidth:i.x,h=0;h<e.length;h++)x=this.ip(e[h],i,s,c),x&&(d=h?c.cellWidth*h-.5+f:f,o.push({x:d,y:x,index:h}));for(u=this.vp(o),h=0;h<o.length;h++){if(b=o[h].x,v=o[h].y,h<o.length-1){for(p=o[h+1].x,w=o[h+1].y,l=b;p>l;l++){var g=this.wp(l,b,h,u.a,u.b,u.c,u.d);
g<i.y&&(g=i.y),g>s.y&&(g=s.y);var m=this.wp(l+1,b,h,u.a,u.b,u.c,u.d);m<i.y&&(m=i.y),m>s.y&&(m=s.y),this.zo(t,l,g,l+1,m,a.line.color(e[h]),a.line.width)}this.zo(t,p-1,this.wp(l,b,h,u.a,u.b,u.c,u.d),p,w,a.line.color(e[h]),a.line.width)}this.lp(t,b,v,e[o[h].index],a.label(e[o[h].index]),n,r)}}},vp:function(t){var e,i,s,n,r,a,h,o,l=[],c=[],u=t.length;
...
return{a:e,b:i,c:s,d:n}},wp:function(t,e,i,s,n,r,a){return s[i]+(t-e)*(n[i]+(t-e)*(r[i]+(t-e)*a[i]))}}),webix.extend(webix.ui.chart,{$render_area:function(t,e,i,s,n,r){var a,h,o,l,c,u,d,f,b,p,x,v,w,g,m;if(u=this.hp(t,e,i,s,n),h=this.s,l=h.eventRadius||Math.floor(u.cellWidth/2),e.length){for(d=[],p=h.offset?i.x+.5*u.cellWidth:i.x,o=0;o<e.length;o++)if(c=e[o],b=this.ip(c,i,s,u),w=p+u.cellWidth*o,b){if(g="object"==typeof b?b.y0:b,o&&this.s.fixOverflow){if(f=this.ip(e[o-1],i,s,u),f.out&&f.out==b.out)continue;
x=u.cellWidth*(o-1)-.5+p,v="object"==typeof f?f.y0:f,f.out&&(m="min"==f.out?s.y:i.y,d.push([this.jp(x,w,v,g,m),m])),b.out&&(m="min"==b.out?s.y:i.y,d.push([this.jp(x,w,v,g,m),m]),o==e.length-1&&m==i.y&&d.push([w,i.y]))}b.out||(d.push([w,g]),r.addRect(c.id,[w-l-i.x,g-l-i.y,w+l-i.x,g+l-i.y],n)),h.yAxis||(a=h.offset||o!=e.length-1?"center":"left",this.canvases[n].renderTextAt(!1,a,w,g-h.labelOffset,h.label(c)))
...
}},$render_stackedArea:function(t,e,i,s,n,r){var a,h,o,l,c,u,d,f,b,p,x,v,w,g;if(p=this.hp(t,e,i,s,n),l=this.s,f=l.eventRadius||Math.floor(p.cellWidth/2),e.length){x=[],g=[],v=l.offset?i.x+.5*p.cellWidth:i.x;var m=function(t,i){return n?e[t].$startY?i-s.y+e[t].$startY:0:i},y=function(t,e,i){var s=(i.y-e.y)/(i.x-e.x);
return s*t+e.y-s*e.x};for(c=0;c<e.length;c++)b=e[c],c?v+=p.cellWidth:(w=m(c,s.y),x.push([v,w])),w=m(c,this.ip(b,i,s,p)),g.push(isNaN(w)&&!c?e[c].$startY||s.y:w),w&&(x.push([v,w]),r.addRect(b.id,[v-f-i.x,w-f-i.y,v+f-i.x,w+f-i.y],n),l.yAxis||(o=!l.offset&&d?"left":"center",this.canvases[n].renderTextAt(!1,o,v,w-l.labelOffset,l.label(b))));
if(x.push([v,m(c-1,s.y)]),n)for(c=e.length-2;c>0;c--)v-=p.cellWidth,w=e[c].$startY,w&&x.push([v,w]);for(x.push([x[0][0],x[0][1]]),t.globalAlpha=this.s.alpha.call(this,e[0]),t.fillStyle=this.s.color.call(this,e[0]),t.beginPath(),this.Mo(t,x),t.fill(),c=0;c<e.length;c++){if(w=g[c],!w)for(c==e.length-1&&(w=e[c].$startY),u=c+1;u<e.length;u++)if(g[u]){a={x:i.x,y:g[0]},h={x:i.x+p.cellWidth*u,y:g[u]},w=y(i.x+p.cellWidth*c,a,h);
...
this.kp=i,n||this.yp(d,o,l,h,e),this.zp(t,d,o,l,h,e,n,r)}},zp:function(t,e,i,s,n,r,a,h){var o,l,c,u,d,f,b,p,x,v,w,g,m,y,_,$,k,S,I;for(c=this.s,d=c.yAxis.start,f=c.yAxis.end,I=this.Ho(d,f),g=I[0],S=g?n/g:n/2,k=I[1],m=-Math.PI/2,o=l=m,x=[],p=0,u=0;u<r.length;u++)$?_=$:(y=c.value(r[u]),this.Bo&&(y=this.Do(y)),_=(parseFloat(y||0)-d)*k),v=Math.floor(S*_),y=c.value(u!=r.length-1?r[u+1]:r[0]),this.Bo&&(y=this.Do(y)),$=(parseFloat(y||0)-d)*k,w=Math.floor(S*$),o=l,l=u!=r.length-1?m+e[u]-1e-4:m,b=p||this.Qo(o,i,s,v),p=this.Qo(l,i,s,w),x.push(b);
c.fill&&this.Ap(t,x,r),!c.disableLines&&r.length>2&&this.Bp(t,x,r),(!c.disableItems||r.length<3)&&this.Cp(t,x,r,a,h),x=null},Cp:function(t,e,i,s,n){for(var r=0;r<e.length;r++)this.lp(t,e[r].x,e[r].y,i[r],this.s.label.call(this,i),s,n)},Ap:function(t,e,i){var s,n;t.globalAlpha=this.s.alpha.call(this,{}),t.beginPath();
...
},yp:function(t,e,i,s,n){var r=this.s.yAxis,a=this.s.xAxis,h=r.start,o=r.end,l=r.step,c={},u=this.to;if("undefined"==typeof u.step||"undefined"==typeof u.start||"undefined"==typeof u.end){var d=this.Go();c=this.Ao(d.min,d.max),h=c.start,o=c.end,l=c.step,r.end=o,r.start=h}var f,b,p,x,v,w=[],g=0,m=s*l/(o-h);
1>l&&(x=Math.min(this.Do(l),0>=h?0:this.Do(h)),v=Math.pow(10,-x));var y=[];this.canvases.scale||(this.canvases.scale=this.lo("radar_scale"));var _=this.canvases.scale.getCanvas();for(f=o;f>=h;f-=l){var $=this.Bo?Math.pow(10,f):f;c.fixNum&&($=parseFloat(f).toFixed(c.fixNum)),w.push(Math.floor(g*m)+.5),v&&!this.Bo&&($=Math.round($*v)/v,f=$);
var k=i-s+w[w.length-1];if(this.canvases.scale.renderTextAt("middle","left",e,k,r.template($.toString()),"webix_axis_item_y webix_radar"),t.length<2)return void this.Dp(_,"arc",e,i,s-w[w.length-1],-Math.PI/2,3*Math.PI/2,f);var S,I=-Math.PI/2,C=I;for(b=0;b<t.length;b++)f==o&&y.push(C),S=I+t[b]-1e-4,this.Dp(_,t.length>2?u.lineShape||"line":"arc",e,i,s-w[w.length-1],C,S,f,b,n[f]),C=S;
g++}for(f=0;f<y.length;f++)p=this.Qo(y[f],e,i,s),a.lines.call(this,n[f],f)&&this.zo(_,e,i,p.x,p.y,a?a.lineColor.call(this,n[f]):"#cfcfcf",1),this.Ep(_,e,i,s,y[f],a?a.template.call(this,n[f]):"&nbsp;")},Dp:function(t,e,i,s,n,r,a,h,o){var l,c;if(0>n)return!1;l=this.Qo(r,i,s,n),c=this.Qo(a,i,s,n);var u=this.s.yAxis;
...
},Xp:function(t,e,i){for(var s=this.s,n="",r=webix.Date.datePart(webix.Date.copy(i.Rp)),a=s.weekNumber?1:0,h=webix.Date.getISOWeek(webix.Date.add(r,2,"day",!0)),o=(this.s.minDate||new Date(1,1,1),this.s.maxDate||new Date(9999,1,1),0);o<e.length;o++){n+="<div class='webix_cal_row' style='height:"+e[o]+"px'>",a&&(n+="<div class='webix_cal_week_num' style='width:"+t[0]+"px'>"+h+"</div>");
...
return e[e.length-1]="#000000",e}var a=[],h=t.rows-1,o=1/t.cols,l=(t.maxLightness-t.minLightness)/h,c=null;a.push(r(t.cols));for(var u=0,d=t.minLightness;h>u;u++){c=[];for(var f=0,b=0;f<t.cols;f++){var p=s(b,1,d);c.push(i(p.r,p.g,p.b)),b+=o}a.push(c),d+=l}this.s.palette=a},render:function(){function t(t,e,i){for(var r='<div class="webix_color_row">',a=0;a<t.length;a++)n.width=e[a],n.height=i,n.val=t[a],r+=s(n);
...
},xq:function(t){var e=this.Dq();e&&(t=t||event,this.Aq=!0,this.Pl=webix.html.pos(t),this.Eq=[],this.Fq(t,e[0]))},yq:function(){this.Aq=!1,this.Pl=!1},Fq:function(t,e){var i,s,n,r,a;t=t||event,i=this.Bq,this.getParentView().x.style.position="relative",n=webix.html.offset(this.x),r=webix.html.offset(this.getParentView().x),a=n[i]-r[i],s=webix.html.offset(e.$view)[i]-webix.html.offset(this.getParentView().$view)[i],this.Rl=[i,e,a,s],this.Gq=new webix.ui.resizearea({container:this.getParentView().x,dir:i,eventPos:this.Pl[i],start:a-1,height:this.$height,width:this.$width,border:1,margin:this.getParentView()["_padding"+i.toUpperCase()]}),this.Gq.attachEvent("onResizeEnd",webix.bind(this.Hq,this)),this.Gq.attachEvent("onResize",webix.bind(this.Iq,this)),webix.html.addCss(document.body,"webix_noselect")
...
},Oq:function(t,e){var i=webix.$$(t);i.Pq||(i.Qq=[],i.Pq={}),i.Pq[e]||(i.Pq[e]=!0,i.Qq.push(e))},Rq:function(t){var e=webix.$$(t);if(this.Nq[this.Nq.length-2]!=t?(10==this.Nq.length&&this.Nq.splice(0,1),this.Nq.push(t)):this.Nq.splice(this.Nq.length-1,1),e.Pq){for(var i=0;i<e.Qq.length;i++)webix.$$(e.Qq[i]).render();
...
for(var e=0;e<t.length;e++)t[e].Ob=this.s.borderless?{top:1,left:1,right:1,bottom:1}:this.s.Ob||{};webix.ui.baselayout.prototype.kc.call(this,t);for(var e=1;e<this.q.length;e++)webix.html.remove(this.q[e].x);for(var e=0;e<t.length;e++){var i=this.q[e];if(!i.q||i.Gc){var s=i.s.Ob;s.top&&(i.x.style.borderTopWidth="0px"),s.left&&(i.x.style.borderLeftWidth="0px"),s.right&&(i.x.style.borderRightWidth="0px"),s.bottom&&(i.x.style.borderBottomWidth="0px")
}}this.Rq(this.getActiveId())},cells_setter:function(t){this.nc=t},Sq:function(t,e){var i=(this.s.animate||{}).direction,s="top"==i||"bottom"==i;return e>t?s?"bottom":"right":s?"top":"left"},fc:function(t,e){var i=this.getParentView();if(i&&i.getTabbar&&i.getTabbar().setValue(t.s.$id||t.s.id),this.Wh)return webix.delay(this.fc,this,[t,e],100);
for(var s=-1,n=0;n<this.q.length;n++)if(this.q[n]==t){s=n;break}if(!(0>s||s==this.Mh)){{var r=this.q[this.Mh],a=this.q[s];r.$getSize(0,0)}if((e||"undefined"==typeof e)&&webix.animate.isSupported()&&this.s.animate){var h=webix.extend({},this.s.animate);h.direction=this.Sq(s,this.Mh),h=webix.Settings.E(e||{},h);
var o=webix.animate.formLine(a.x,r.x,h);a.$getSize(0,0),a.$setSize(this.bc,this.dc);var l=h.callback;h.callback=function(){webix.animate.breakLine(o),this.Wh=!1,l&&l.call(this),l=h.master=h.callback=null,this.resize()},h.master=this,this.Mh=s,this.Rq(this.getActiveId()),webix.animate(o,h),this.Wh=!0}else webix.html.remove(r.x),this.Mh=s,this.x.appendChild(this.q[n].x),r.resize(),this.Rq(this.getActiveId());
...
}},webix.ui.toolbar),webix.protoUI({name:"gridsuggest",defaults:{type:"datatable",fitMaster:!1,width:0,body:{navigation:!0,autoheight:!0,autowidth:!0,select:!0},filter:function(t,e){var i=this.config.template(t);return 0===i.toString().toLowerCase().indexOf(e.toLowerCase())?!0:!1}},$init:function(t){t.body.columns||(t.body.autoConfig=!0),t.template||(t.template=webix.bind(this.bu,this))
},bu:function(t){var e=this.getBody(),i=this.config.textValue||e.config.columns[0].id;return e.getText(t.id,i)}},webix.ui.suggest),webix.protoUI({name:"datasuggest",defaults:{type:"dataview",fitMaster:!1,width:0,body:{xCount:3,autoheight:!0,select:!0}}},webix.ui.suggest),webix.protoUI({name:"multiselect",$cssName:"richselect",defaults:{separator:","},Kt:function(t){var e=!webix.isArray(t)&&"object"==typeof t&&!t.name,i={view:"multisuggest",separator:this.config.separator};
this.s.optionWidth?i.width=this.s.optionWidth:i.fitMaster=!0,e&&webix.extend(i,t,!0);var s=webix.ui(i),n=s.getList();return"string"==typeof t?n.load(t):e||n.parse(t),s},$setValue:function(t){if(this.se){var e=this.getPopup();this.getInputNode().innerHTML=e?e.setValue(t):""}},getValue:function(){return this.s.value||""
}},webix.ui.richselect),webix.editors.multiselect=webix.extend({popupType:"multiselect"},webix.editors.richselect),webix.type(webix.ui.list,{name:"multilist",templateStart:webix.template('<div webix_l_id="#!id#" class="{common.classname()}" style="width:{common.widthSize()}; height:{common.heightSize()}; overflow:hidden;">')},"default"),webix.protoUI({name:"multisuggest",defaults:{separator:",",type:"layout",width:0,body:{rows:[{view:"list",type:"multilist",autoheight:!0,yCount:5,multiselect:"touch",select:!0},{view:"button",click:function(){var t=this.getParentView().getParentView();
t.setMasterValue({id:t.getValue()}),t.hide()}}]}},Jt:function(t){return t.rows[0]},_d:function(){var t=this.getButton();t.s.value=this.s.buttonText||webix.i18n.controls.select,t.refresh()},getButton:function(){return this.getBody().getChildViews()[1]},getList:function(){return this.getBody().getChildViews()[0]
},setValue:function(t){"string"==typeof t&&(t=t.split(this.config.separator));var e=[],i=this.getList();if(i.unselect(),t[0])for(var s=0;s<t.length;s++)i.exists(t[s])&&(i.select(t[s],!0),e.push(this.getItemText(t[s])));return e.join(this.config.separator+" ")},getValue:function(){return this.getList().getSelectedId(!0).sort().join(this.config.separator)
}},webix.ui.suggest),webix.editors.$popup.multiselect={view:"multisuggest"},webix.protoUI({name:"menu",Oh:"webix_menu",$init:function(){this.data.attachEvent("onStoreUpdated",webix.bind(function(){this.Uq()},this)),this.attachEvent("onMouseMove",this.Vq),this.attachEvent("onMouseOut",function(){this.Wq()&&"click"==this.s.openAction||this.Xq||this.Uq()
...
},kr:function(t){return this.callEvent("onBeforeShow",[t])?(this.show(t,null,!0),webix.callEvent("onClick",[t]),webix.html.preventEvent(t)):void 0},gr:!0,master_setter:function(t){return this.attachTo(t),null}},webix.protoUI({name:"context"},webix.ContextHelper,webix.ui.popup),webix.protoUI({name:"contextmenu",$q:!0,$init:function(t){t.submenuConfig&&webix.extend(t,t.submenuConfig)
...
f.hide();var b=f.getBody()||null;if(b)if(d.max){var p=!1;for(n=0;n<u.length&&!p;n++)if(u[n].id==t.value&&(p=!0,n+1>d.max)){var x=u.splice(n+1-d.max,d.max);u=x.concat(u)}b.clearAll(),b.parse(u.slice(d.max))}else b.clearAll()}else e.s.tabbarPopup&&webix.$$(e.s.tabbarPopup).hide();o=t.tabOffset;var v=!1;
...
}if("config"==n){this.Vr(u,i,e);var f=u;u=u.nextSibling,webix.html.remove(f);continue}if("column"==n){l=1;var b=this.Wr(u,e);b.header=b.header||b.value,b.width=1*b.width||"",i.columns=i.columns||[],i.columns.push(b)}else if(n||h&&e){var p=this.Or(u,e,{view:n});"head"==p.view?i.head=p.rows?p.rows[0]:p.template:"body"==p.view?this.Mr(i.view,"addView")?o.push({body:p.rows?p.rows[0]:p.value,header:p.header||""}):i.body=p.rows?1==p.rows.length?p.rows[0]:{rows:p.rows}:p.value:o.push(p)
}else if(c){l=1;var x=u.tagName;e&&(x=x.toLowerCase().replace(this.Ys,this.Zs)),i[x]=webix.DataDriver.xml.tagToObject(u)}}u=u.nextSibling}if(this.Xr(t,i,e),o.length)i.stack?i[i.stack]=o:this.Mr(i.view,"setValues")?i.elements=o:"rows"==i.view?(i.view="layout",i.rows=o):"cols"==i.view?(i.view="layout",i.cols=o):this.Mr(i.view,"setValue")?i.cells=o:this.Mr(i.view,"getBody")?i.body=1==o.length?o[0]:{rows:o}:i.rows=o;
...
swfobject.getFlashPlayerVersion();webix.event(this.x,"click",webix.bind(function(){var t=new Date;t-(this.ds||0)>250&&this.fileDialog()},this)),this.files.attachEvent("onBeforeDelete",webix.bind(this.as,this))},Ov:function(t,e){return this[t].apply(this,e)},getSwfObject:function(){return swfobject.getObjectById(this.s.swfId)
...
if(i.length)for(var n=0;n<i.length;n++)s=!this.send(i[n],e)&&s;return void(s&&this.gs())}var r=this.files.getItem(t);if("client"!==r.status)return!1;r.status="transfer";var a=new FormData;if(a.append("upload",r.file),e)for(var h in e)a.append(h,e[h]);var o=r.xhr=new XMLHttpRequest;return o.upload.addEventListener("progress",webix.bind(function(e){this.hs(t,e.loaded/e.total*100)
},this),!1),o.onload=webix.bind(function(){o.aborted||this.is(t)},this),o.open("POST",this.s.upload,!0),o.send(a),this.hs(t,0),!0},is:function(t){var e=this.files.getItem(t);if(e){var i=null;200==e.xhr.status&&(i=webix.DataDriver.json.toObject(e.xhr.responseText)),i&&"error"!=i.status?this.js(t,i):(e.status="error",delete e.percent,this.files.updateItem(t),this.callEvent("onFileUploadError",[e,i])),delete e.xhr
}},stopUpload:function(t){webix.bind(this.as,this.files)(t)},as:function(t){var e=this.getItem(t);"undefined"!=typeof e.xhr&&(e.xhr.aborted=!0,e.xhr.abort()),delete e.xhr,e.status="client"}}},webix.protoUI({name:"uploader",defaults:{autosend:!0,multiple:!0},$cssName:"button",Ce:!0,send:function(){},fileDialog:function(){},stopUpload:function(){},$init:function(){var t=webix.UploadDriver.html5;
...
return"webix_slider_handle"==e.className?(this.$x=this.s.value,this.ts.apply(this,arguments)):void(-1!=e.className.indexOf("webix_slider")&&(this.$x=this.s.value,this.s.value=this.us.apply(this,arguments),this.ts(t)))},ts:function(){this.vs=webix.env.touch?[this.attachEvent("onTouchMove",webix.bind(this.ws,this)),this.attachEvent("onTouchEnd",webix.bind(this.xs,this))]:[webix.event(document.body,"mousemove",webix.bind(this.ws,this)),webix.event(document.body,"mouseup",webix.bind(this.xs,this))],webix.html.addCss(document.body,"webix_noselect")
},xs:function(){this.vs&&(webix.env.touch?(webix.detachEvent(this.vs[0]),webix.detachEvent(this.vs[1])):(webix.eventRemove(this.vs[0]),webix.eventRemove(this.vs[1])),this.vs=[]),webix.html.removeCss(document.body,"webix_noselect");var t=this.s.value;this.s.value=this.$x,this.setValue(t)},ws:function(){this.s.value=this.us.apply(this,arguments),this.refresh(),this.callEvent("onSliderDrag",[])
},us:function(t,e){var i=0;return i=webix.env.touch?e?e.x:t.x:webix.html.pos(t).x,this.ys(i)},ys:function(t){var e=this.s,i=e.max-e.min,s=webix.html.offset(this.rs().parentNode).x,n=Math.ceil((t-s)*i/this.Ee(e));return n=Math.round((n+e.min)/e.step)*e.step,Math.max(Math.min(n,e.max),e.min)},De:function(){}},webix.ui.text),webix.proxy.offline={$proxy:!0,storage:webix.storage.local,cache:!1,data:"",zs:function(){this.cache||webix.env.offline||(webix.call("onOfflineMode",[]),webix.env.offline=!0)
},As:function(){!this.cache&&webix.env.offline&&(webix.env.offline=!1,webix.call("onOnlineMode",[]))},load:function(t,e){var i={error:function(){var i=this.getCache()||this.data,s={responseText:i},n=webix.ajax.prototype.J(s);this.zs(),webix.ajax.$callback(t,e,i,n,s)},success:function(i,s,n){this.As(),webix.ajax.$callback(t,e,i,s,n),this.setCache(i)
}};this.cache&&this.getCache()?i.error.call(this):this.source.$proxy?this.source.load(this,i):webix.ajax(this.source,i,this)},getCache:function(){return this.storage.get(this.Bs())},clearCache:function(){this.storage.remove(this.Bs())},setCache:function(t){this.storage.put(this.Bs(),t)},Bs:function(){return this.source.$proxy?this.source.source+"_$proxy$_data":this.source+"_$proxy$_data"
},saveAll:function(t,e,i,s){this.setCache(t.serialize()),webix.ajax.$callback(t,s,"",e)},result:function(t,e,i,s,n){for(var r=0;r<n.length;r++)i.processResult({id:n[r].id,status:n[r].operation},{},{})}},webix.proxy.cache={init:function(){webix.extend(this,webix.proxy.offline)},cache:!0},webix.proxy.local={init:function(){webix.extend(this,webix.proxy.offline)
},cache:!0,data:[]},window.angular&&function(){function t(t){var e=t.attr("id");return e||(e=webix.uid(),t.attr("id",e)),e}angular.module("webix",[]).directive("webixUi",["$parse",function(e){return{restrict:"A",scope:!1,link:function(i,s,n){{var r=n.webixUi,a=n.webixReady,h=null;t(s)}s.ready(function(){if(!h){if(a&&(a=e(a)),s.bind("$destroy",function(){h&&h.destructor()
}),r){var t=function(){if(h&&h.destructor(),i[r]){var t=webix.copy(i[r]);t.$scope=i,h=webix.ui(t,s[0]),a&&a(i,{root:h})}};i.$watch(r,t),t()}else{n.view||s.attr("view","rows");var o=webix.markup,l=o.attribute;o.attribute="",h="undefined"!=typeof n.webixRefresh?o.init(s[0],s[0],i):o.init(s[0],null,i),o.attribute=l,a&&a(i,{root:h})
}i.$watch(function(){return s[0].offsetWidth+"."+s[0].offsetHeight},function(){h&&h.adjust()})}})}}}]).directive("webixShow",["$parse",function(e){return{restrict:"A",scope:!1,link:function(i,s,n){var r=e(n.webixShow),a=t(s);r(i)||s.attr("hidden","true"),i.$watch(n.webixShow,function(){var t=webix.$$(a);
t&&(r(i)?(webix.$$(a).show(),s[0].removeAttribute("hidden")):webix.$$(a).hide())})}}}]).directive("webixEvent",["$parse",function(e){var i=function(t,i,s){var n=s.split("="),r=e(n[1]),a=n[0].trim();i.attachEvent(a,function(){return r(t,{id:arguments[0],details:arguments})})};return{restrict:"A",scope:!1,link:function(e,s,n){var r=n.webixEvent.split(";"),a=t(s);
setTimeout(function(){var t=s[0].firstChild;t&&1==t.nodeType&&(a=t.getAttribute("view_id")||a);for(var n=webix.$$(a),h=0;h<r.length;h++)i(e,n,r[h])})}}}]).directive("webixElements",["$parse",function(){return{restrict:"A",scope:!1,link:function(e,i,s){var n=s.webixElements,r=t(i);e.$watchCollection&&e.$watchCollection(n,function(t){setTimeout(function(){var e=webix.$$(r);
...
this.x.scrollWidth!=this.$width&&(this.cu.style.left=i.x+"px"),this.x.scrollHeight!=this.$height&&(this.cu.style.top="bottom"!=t.type?i.y+"px":i.y+this.$height-this.cu.offsetHeight+"px")}this.du=1}t&&"icon"!=t.type&&webix.delay(function(){if(this.cu){var e=t.position||1;this.cu.firstChild.style.width=100*e+"%",t.delay&&(this.cu.firstChild.style[webix.env.transitionDuration]=t.delay+"ms"),t.hide&&webix.delay(this.hideProgress,this,[1],t.delay)
}this.du=0},this)},hideProgress:function(t){this.du&&(t=!0),this.cu&&(t?(webix.html.remove(this.cu),this.cu=null):this.showProgress({position:1.1,delay:300,hide:!0}))}},webix.protoUI({name:"multitext",$cssName:"text",defaults:{icon:"plus-circle",iconWidth:25,separator:", "},getValueHere:function(){return webix.ui.text.prototype.getValue.call(this)
...
},$setValue:function(t){if(t=t||"",this.fu!=t){if(this.fu=t,"extra"==this.config.mode)return this.setValueHere(t);this.removeSection();var e=t.split(this.config.separator);this.setValueHere.call(this,e[0]);for(var i=1;i<e.length;i++){var s=this.addSection();webix.$$(s).setValueHere(e[i])}}},addSection:function(){var t=this.getParentView().addView({labelWidth:this.config.labelWidth,inputWidth:this.config.inputWidth,width:this.config.width,label:this.config.label?"&nbsp;":"",view:"multitext",mode:"extra",value:"",icon:"minus-circle",master:this.config.id});
return this.eu.push(t),t},removeSection:function(t){for(var e=this.config.master?webix.$$(this.config.master):this,i=e.eu.length-1;i>=0;i--){var s=e.eu[i];t&&s!=t||(e.eu.removeAt(i),this.getParentView().removeView(s))}},on_click:{webix_input_icon:function(){if("extra"==this.config.mode){this.removeSection(this.config.id);
var t=this.getParentView().getChildViews();t[t.length-1].focus()}else webix.$$(this.addSection()).focus();return!1}},$init:function(){this.eu=webix.toArray([])},$render:function(t){this.$setValue(t.value)}},webix.ui.text),webix.protoUI({name:"organogram",defaults:{scroll:"auto"},$init:function(){this.x.className+=" webix_organogram",this.v=document.createElement("DIV"),this.$ready.push(this.Av),webix.extend(this.data,webix.TreeStore,!0),this.data.provideApi(this,!0)
},ad:"webix_dg_id",on_click:{webix_organogram_item:function(t,e){this.s.select&&("multiselect"==this.s.select||this.s.multiselect?this.select(e,!1,t.ctrlKey||t.metaKey||"touch"==this.s.multiselect,t.shiftKey):this.select(e),this.Qh=!1)}},on_context:{},on_dblclick:{},Av:function(){this.y.style.position="relative",this.data.attachEvent("onStoreUpdated",webix.bind(this.render,this))
},pg:function(t){var e=this.data.Me[t.id];return this.callEvent("onItemRender",[t]),this.type.templateStart.call(this,t,this.type,e)+(t.$template?this.type["template"+t.$template].call(this,t,this.type,e):this.type.template.call(this,t,this.type,e))+this.type.templateEnd.call(this)},jb:function(t){var e=this.pg(t);
return this.data.branch[t.id]&&(e+=this.by(t.id)),e},by:function(t){var e,i,s,n,r="",a=this.data.branch[t],h=this.data.Me[t],o=this.getItem(t),l=o?o.$type:!1;if(t||(this.cy=[],this.$xy={},n=this.$width-2*this.type.padding,this.$xy[0]={totalWidth:n,start:this.type.padding,width:0,height:0,left:n/2,top:this.type.padding||0}),a){s=this.$xy[t],"list"==l&&(r+=this.type.templateListStart.call(this,o,this.type,h));
var c=0;for(e=0;e<a.length;e++){i=a[e],n=this.dy[i];var u=this.getItem(i);"list"==l&&this.data.addMark(i,"list_item","",1,!0);var d=this.ey(i);this.$xy[i]="list"==l?{totalWidth:n,start:s.start,width:this.type.width,height:d,left:s.start+n/2-this.type.width/2,top:e?this.$xy[a[e-1]].top+this.$xy[a[e-1]].height:s.top+s.height+this.type.marginY}:{totalWidth:n,start:s.start+c,width:this.type.width,height:d,left:s.start+c+n/2-this.type.width/2,top:s.top+s.height+(t?this.type.marginY:0)},r+=this.pg(u),c+=n
}for(!t&&c&&(this.y.style.width=c+2*this.type.padding+"px"),e=0;e<a.length;e++)i=a[e],this.data.branch[i]?r+=this.by(i):"list"!=o.$type?this.cy.push(this.$xy[i].top+this.$xy[i].height):e==a.length-1&&this.cy.push(this.$xy[i].top+this.$xy[i].height);"list"==l&&(r+=this.type.templateListEnd(o,this.type,h))
}return r},ey:function(t){var e=this.getItem(t),i=this.type.height;return"function"==typeof i&&(i=i.call(e,this.type,this.data.Me[t])),this.fy||(this.fy=webix.html.create("div"),this.y.appendChild(this.fy)),this.fy.className=this.type.classname(e,this.type,this.data.Me[t]),this.fy.style.cssText="width:"+this.type.width+"px;height:"+i+("auto"==i?"":"px")+";",this.fy.innerHTML=this.type.template.call(this,e,this.type),this.fy.scrollHeight
},gy:function(){var t={},e=this.type.width,i=this.type.marginX;return this.data.each(function(s){t[s.id]=e+i;var n=this.getParentId(s.id);if(n&&"list"!=this.getItem(n).$type)for(;n;){var r=this.branch[n];t[n]=0;for(var a=0;a<r.length;a++)t[n]+=t[r[a]]||0;n=this.getParentId(n)}}),this.dy=t,t},getItemNode:function(t){if(this.t)return this.t[t];
this.t={};for(var e=this.y.childNodes,i=0;i<e.length;i++){var s=e[i].getAttribute(this.ad);if(s&&(this.t[s]=e[i]),-1!=e[i].className.indexOf("webix_organogram_list"))for(var n=e[i].childNodes,r=0;r<n.length;r++)s=n[r].getAttribute(this.ad),s&&(this.t[s]=n[r])}return this.getItemNode(t)},Ne:function(t){return this.v.innerHTML=this.pg(t),this.v.firstChild
},render:function(t,e,i){if(this.isVisible(this.s.id)&&!this.$blockRender){if("update"==i){var s=this.getItemNode(t),n=this.t[t]=this.Ne(e);return webix.html.insertBefore(n,s),webix.html.remove(s),!0}return this.callEvent("onBeforeRender",[this.data])&&(this.gy(),this.t=null,this.y.innerHTML=this.by(0),this.fy=null,this.y.style.height=Math.max.apply(Math,this.cy)+this.type.padding+"px",this.hy(),this.resize(),this.callEvent("onAfterRender",[])),!0
}},hy:function(){this.canvas&&this.canvas.clearCanvas(!0),this.canvas=new webix.Canvas({container:this.y,name:"lines",width:this.y.offsetWidth,height:this.y.offsetHeight}),this.iy(0)},zo:function(t,e,i,s,n,r,a){t.strokeStyle=r,t.lineWidth=a,t.beginPath(),t.moveTo(e,i),t.lineTo(s,n),t.stroke(),t.lineWidth=1
},iy:function(t,e){{var i,s,n,r,a,h,o,l,c,u;this.config.layout}if(e||(e=this.canvas.getCanvas()),this.$xy&&(t=t||0,n=this.data.branch[t],s=this.getItem(t),n&&n.length)){if(r=this.$xy[t],t){if(h=parseInt(r.left+r.width/2,10)+.5,o=parseInt(r.top+r.height,10),l=parseInt(r.top+r.height+this.type.marginY/2,10),"list"==s.$type)return l=parseInt(r.top+r.height+this.type.marginY,10),void this.zo(e,h,o,h,l,this.type.lineColor);
this.zo(e,h,o,h,l,this.type.lineColor)}for(o=parseInt(r.top+r.height+this.type.marginY/2,10)+.5,i=0;i<n.length;i++){if(t){a=this.$xy[n[i]];var h=parseInt(a.left+a.width/2,10)+.5;i?i==n.length-1&&(u=h):c=h,l=parseInt(a.top,10),this.zo(e,h,o,h,l,this.type.lineColor)}this.iy(n[i],e)}t&&this.zo(e,c,o,u,o,this.type.lineColor)
}},$getSize:function(t,e){var i=this.s.autowidth,s=this.s.autoheight;return i&&(t=this.y.offsetWidth+(this.y.offsetHeight>e&&!s?webix.ui.scrollSize:0)),s&&(e=this.y.offsetHeight+(this.y.offsetWidth>t&&!i?webix.ui.scrollSize:0)),webix.ui.view.prototype.$getSize.call(this,t,e)},$setSize:function(t,e){webix.ui.view.prototype.$setSize.call(this,t,e)&&(this.y.style.width=this.$width+"px",this.y.style.height=this.$height+"px",this.render())
},type:{width:120,height:"auto",padding:20,marginX:20,marginY:20,lineColor:"#90caf9",classname:function(t,e,i){var s="webix_organogram_item ";return t.$css&&("object"==typeof t.$css&&(t.$css=webix.html.createCss(t.$css)),s+=" "+t.$css),i&&i.list_item&&(s+=" webix_organogram_list_item "),i&&i.$css&&(s+=i.$css),s+=" webix_organogram_level_"+t.$level
},listClassName:function(t){var e="webix_organogram_list webix_organogram_list_"+t.$level;return t.$listCss&&("object"==typeof t.$listCss&&(t.$listCss=webix.html.createCss(t.$listCss)),e+=" "+t.$listCss),e},template:webix.template("#value#"),templateStart:function(t,e,i){var s="";if((!i||!i.list_item)&&this.$xy){var n=this.$xy[t.id];
s+="width: "+n.width+"px; height: "+n.height+"px;",s+="top: "+n.top+"px; left: "+n.left+"px;"}return'<div webix_dg_id="'+t.id+'" class="'+e.classname(t,e,i)+'"'+(s?'style="'+s+'"':"")+'">'},templateEnd:webix.template("</div>"),templateListStart:function(t,e,i){var s="";if(this.$xy){var n=this.$xy[t.id];
s+="width: "+n.width+"px;",s+="top: "+(n.top+n.height+e.marginY)+"px; left: "+n.left+"px;"}return'<div class="'+e.listClassName(t,e,i)+'"'+(s?'style="'+s+'"':"")+'">'},templateListEnd:webix.template("</div>")}},webix.AutoTooltip,webix.Group,webix.TreeAPI,webix.DataMarks,webix.SelectionModel,webix.MouseEvents,webix.Scrollable,webix.RenderStack,webix.TreeDataLoader,webix.DataLoader,webix.ui.view,webix.EventSystem),webix.protoUI({name:"barcode",defaults:{type:"ean13",height:160,width:220,paddingY:10,paddingX:20,textHeight:20,color:"#000"},$init:function(){this.$view.className+=" webix_barcode",this.types||(this.types={"default":this.type},this.type.name="default")
},type:{},render:function(){this.isVisible(this.s.id)&&(this.canvas&&this.canvas.clearCanvas(!0),this.$view.innerHTML="",this.hy())},hy:function(){this.canvas=new webix.Canvas({container:this.$view,name:"bars",width:this.$width,height:this.$height}),this.jy()},jy:function(){var t,e,i,s,n=this.s.value,r=this.s.type;
if(!r||!this.types[r]||!n)return!1;if(t=this.type.encode(n),s=t.length,e=this.canvas.getCanvas(),s){var a=(this.$width-2*this.config.paddingX)/s,h=0;for(i=0;s>i;i++){var o=parseInt(t.charAt(i),10);o?(h++,i==s-1&&this.bp(e,i+1,a,h,s)):h&&(this.bp(e,i,a,h,s),h=0)}this.ky(n,a)}},bp:function(t,e,i,s,n){var r,a,h,o;
a=parseInt(e*i+this.config.paddingX,10),r=parseInt(a-s*i,10),h=this.config.paddingY,o=this.$height-this.config.paddingY-this.config.textHeight,this.ly()&&(4>e||e>n-4||n/2+2>e&&e>n/2-2)&&(o+=this.config.textHeight/2),t.fillStyle=this.config.color,t.beginPath(),t.moveTo(r,h),t.lineTo(a,h),t.lineTo(a,o),t.lineTo(r,o),t.lineTo(r,h),t.fill()
},ky:function(t,e){var i,s,n;if(this.type.template&&(t=this.type.template(t)),this.ly()){if(this.type.firstDigit&&(this.canvas.renderTextAt(!0,"left",this.config.paddingX,this.$height-this.config.paddingY,t.charAt(0)),t=t.slice(1)),s=t.length,this.type.lastDigit&&s--,s){var r=(this.$width-2*this.config.paddingX-11*e)/s;
for(i=0;s>i;i++)n=this.config.paddingX+i*r+(s/2>i?3:8)*e+r/2,this.canvas.renderTextAt(!0,!0,n,this.$height-this.config.paddingY,t.charAt(i));this.type.lastDigit&&(n=this.config.paddingX+s*r+11*e,this.canvas.renderTextAt(!0,!1,n,this.$height-this.config.paddingY,t.charAt(s)))}}else this.canvas.renderTextAt(!0,!0,this.$width/2,this.$height-this.config.paddingY,t)
},setValue:function(t){return this.s.value=t,this.render(),t},getValue:function(){var t=this.s.value;return this.type.template?this.type.template(t):t},type_setter:function(t){return this.types[t]?(this.type=webix.clone(this.types[t]),this.type.css&&(this.w.className+=" "+this.type.css)):this.customize(t),t
},ly:function(){var t=this.config.type;return 0===t.indexOf("ean")||-1!=t.indexOf("upcA")},$setSize:function(t,e){webix.ui.view.prototype.$setSize.call(this,t,e)&&this.render()}},webix.ui.view),webix.type(webix.ui.barcode,{name:"ean8",encodings:[["0001101","1110010"],["0011001","1100110"],["0010011","1101100"],["0111101","1000010"],["0100011","1011100"],["0110001","1001110"],["0101111","1010000"],["0111011","1000100"],["0110111","1001000"],["0001011","1110100"]],encode:function(t){var e,i;
if(t=t.replace(/[^0-9]/g,"").substring(0,7),7!=t.length)return"";for(t+=this.checksum(t),e="101",i=0;4>i;i++)e+=this.encodings[parseInt(t.charAt(i),10)][0];for(e+="01010",i=4;8>i;i++)e+=this.encodings[parseInt(t.charAt(i),10)][1];return e+="101"},template:function(t){return t.replace(/[^0-9]/g,"").substring(0,7)+this.checksum(t)
},checksum:function(t){t=t.substring(0,7);var e,i=!0,s=0;for(e=0;7>e;e++)s+=(i?3:1)*parseInt(t.charAt(e),10),i=!i;return((10-s%10)%10).toString()}}),webix.type(webix.ui.barcode,{name:"ean13",firstDigit:!0,encodings:[["0001101","0100111","1110010","000000"],["0011001","0110011","1100110","001011"],["0010011","0011011","1101100","001101"],["0111101","0100001","1000010","001110"],["0100011","0011101","1011100","010011"],["0110001","0111001","1001110","011001"],["0101111","0000101","1010000","011100"],["0111011","0010001","1000100","010101"],["0110111","0001001","1001000","010110"],["0001011","0010111","1110100","011010"]],encode:function(t){var e,i,s;
if(t=t.replace(/[^0-9]/g,"").substring(0,12),12!=t.length)return"";for(t+=this.checksum(t),e="101",i=this.encodings[parseInt(t.charAt(0),10)][3],s=1;7>s;s++)e+=this.encodings[parseInt(t.charAt(s),10)][parseInt(i.charAt(s-1),10)];for(e+="01010",s=7;13>s;s++)e+=this.encodings[parseInt(t.charAt(s),10)][2];
return e+="101"},template:function(t){return t.replace(/[^0-9]/g,"").substring(0,12)+this.checksum(t)},checksum:function(t){var e,i=!1,s=0;for(t=t.substring(0,12),e=0;12>e;e++)s+=(i?3:1)*parseInt(t.charAt(e),10),i=!i;return((10-s%10)%10).toString()}}),webix.type(webix.ui.barcode,{name:"upcA",firstDigit:!0,lastDigit:!0,encode:function(t){return t.length<12&&(t="0"+t),webix.ui.barcode.prototype.types.ean13.encode(t)
},template:function(t){return t.replace(/[^0-9]/g,"").substring(0,11)+this.checksum(t)},checksum:function(t){return t.length<12&&(t="0"+t),webix.ui.barcode.prototype.types.ean13.checksum(t)}}),webix.protoUI({name:"video",$init:function(t){t.id||(t.id=webix.uid()),this.$ready.push(this.Ms)},Ms:function(){var t=this.s;
if(this.w=webix.html.create("video",{"class":"webix_view_video",style:"width:100%;height:100%;",autobuffer:"autobuffer"},""),t.poster&&(this.w.poster=t.poster),t.src){"object"!=typeof t.src&&(t.src=[t.src]);for(var e=0;e<t.src.length;e++)this.w.innerHTML+=' <source src="'+t.src[e]+'">'}t.controls&&(this.w.controls=!0),t.autoplay&&(this.w.autoplay=!0),this.x.appendChild(this.w)
},getVideo:function(){return this.w},defaults:{src:"",controls:!0}},webix.ui.view),function(){var t=webix.CustomScroll={scrollStep:40,init:function(){this.ze(),webix.env.$customScroll=!0,webix.ui.scrollSize=0,webix.destructors.push({destructor:function(){this.gu=null}}),webix.attachEvent("onReconstruct",t.hu)
},mk:function(e){e.Vf.iu=e.s.id,e.attachEvent("onAfterRender",function(){var e=t.ju(this),i=Math.max(e.dy-e.py,0),s=Math.max(e.dx-e.px,0);this.jk>i?this.lk(i):this.bk>s&&this.kk(s),t.gu==this.Vf&&t.hu()}),webix.event(e.Vf,"mouseover",t.ku),webix.event(e.Vf,"mouseout",t.lu)},enable:function(e,i){if(t.ze(),e.columns_setter)return this.mk(e);
var s=e;e.y&&(s=e.y.parentNode),s.mu=i||"xy",webix.event(s,"mouseover",t.ku),webix.event(s,"mouseout",t.lu),webix.event(s,"mousewheel",t.nu),webix.event(s,"DOMMouseScroll",t.nu)},hu:function(){var e=t.gu;e&&e.ou&&(t.pu.call(e),t.ku.call(e))},ze:function(){webix.event(document.body,"mousemove",function(e){t.qu&&t.ru(t.qu,t.qu.su,webix.html.pos(e))
}),t.ze=function(){}},ku:function(){if(t.gu=this,clearTimeout(this.tu),!this.ou&&!t.qu){var e;if(this.iu){var i=webix.$$(this.iu);if(!i)return;e=t.ju(i)}else e={dx:this.scrollWidth,dy:this.scrollHeight,px:this.offsetWidth,py:this.offsetHeight},e.ec=e.dx>e.px&&-1!=this.mu.indexOf("x"),e.cc=e.dy>e.py&&-1!=this.mu.indexOf("y");
this.ou=e,e.ec&&(e.uu=t.Om(this,"x",e.dx,e.px,"width","height"),e.vu=e.px-e.uu.offsetWidth-4,e.wu=e.dx-e.px),e.cc&&(e.xu=t.Om(this,"y",e.dy,e.py,"height","width"),e.yu=e.py-e.xu.offsetHeight-4,e.zu=e.dy-e.py),t.sk(this)}},ru:function(e,i,s){var n=e.ou,r=e.iu;if(r&&(r=webix.$$(r)),n.uu==e.Au){var a=(s.x-i.x)*n.wu/n.vu;
r?r.Zj.scrollTo(r.bk+a):t.Bu(e,"scrollLeft",a)}if(n.xu==e.Au){var a=(s.y-i.y)*n.zu/n.yu;r?r.Wj.scrollTo(r.jk+a):t.Bu(e,"scrollTop",a)}e.su=s,t.sk(e)},ju:function(t){var e={};return t.Zj&&(e.dx=t.Zj.s.scrollWidth,e.px=t.Zj.Si||1,e.ec=e.dx-e.px>1),t.Wj&&(e.dy=t.Wj.s.scrollHeight,e.py=t.Wj.Si||1,e.cc=e.dy-e.py>1),e
},lu:function(){clearTimeout(this.tu),this.tu=webix.delay(t.pu,this,[],200)},Cu:function(t){t&&(webix.html.remove(t),t.Du&&(webix.eventRemove(t.Du),webix.eventRemove(t.Eu)))},pu:function(){if(this.ou){if(this.Au)return void(this.Fu=!0);var e=this.ou;t.Cu(e.uu),t.Cu(e.xu),this.ou=null}},nu:function(e){var i=this.ou,s=e.wheelDelta/-40,n=!0;
if(!s&&e.detail&&webix.isUndefined(e.wheelDelta)&&(s=e.detail),i)if(i.uu&&(e.wheelDeltaX||s&&!i.xu)){var r=e.wheelDeltaX/-40||s;n=t.Bu(this,"scrollLeft",r*t.scrollStep)}else s&&i.xu&&(n=t.Bu(this,"scrollTop",s*t.scrollStep));return t.sk(this),n!==!1?webix.html.preventEvent(e):void 0},Bu:function(e,i,s){var n=e.ou,r="scrollLeft"==i?n.dx-n.px:n.dy-n.py,a=e[i];
return a+s>r&&(s=r-a),!s||0>a+s&&0===a?!1:(webix.env.isIE?(t.sk(e,i,s+a),e[i]+=s):e[i]+=s,!0)},Om:function(e,i,s,n,r){var a=webix.html.create("DIV",{webixignore:"1","class":"webix_c_scroll_"+i},"<div></div>");return a.style[r]=Math.max(n*n/s-7,40)+"px",e.style.position="relative",e.appendChild(a),e.Du=webix.event(a,"mousedown",t.Gu(e)),e.Eu=webix.event(document.body,"mouseup",webix.bind(t.Hu,e)),a
},Gu:function(e){return function(i){this.className+=" webix_scroll_active",t.qu=e,e.Au=this,e.su=webix.html.pos(i)}},Hu:function(){this.Au&&(this.Au.className=this.Au.className.toString().replace(" webix_scroll_active",""),this.Au=!1,t.qu=0,this.Fu&&(t.pu.call(this),this.Fu=!1))},sk:function(t,e,i){var s=t.ou;
if(s&&(s.uu||s.xu)){var n=t.iu,r="scrollLeft"==e?i:t.scrollLeft,a=n?webix.$$(n).bk:r,h=n?0:a,o="scrollTop"==e?i:t.scrollTop,l=n?webix.$$(n).jk:o,c=n?0:l;s.uu&&(s.uu.style.bottom=1-c+"px",s.uu.style.left=Math.round(s.vu*a/(s.dx-s.px))+h+1+"px"),s.xu&&(s.xu.style.right=1-h+"px",s.xu.style.top=Math.round(s.yu*l/(s.dy-s.py))+c+1+"px")
}}}}(),webix.UIManager.getState=function(t,e){e=e||!1,t=webix.$$(t);var i={id:t.config.id,width:t.config.width,height:t.config.height,gravity:t.config.gravity};if(webix.isUndefined(t.config.collapsed)||(i.collapsed=t.config.collapsed),("tabs"===t.name||"tabbar"===t.name)&&(i.activeCell=t.getValue()),e&&(i=[i],t.q))for(var s=0;s<t.q.length;s++)i=i.concat(this.getState(t.q[s],e));
return i},webix.UIManager.setState=function(t){webix.isArray(t)||(t=[t]);for(var e=0;e<t.length;e++){var i=t[e],s=webix.$$(i.id);s&&(webix.isUndefined(i.collapsed)||s.define("collapsed",i.collapsed),webix.isUndefined(i.activeCell)||s.setValue(i.activeCell),s.define("width",i.width),s.define("height",i.height),s.define("gravity",i.gravity))
}var n=webix.$$(t[0].id);n&&n.resize()};
